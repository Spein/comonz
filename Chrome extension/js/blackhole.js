function blackhole(element, count, gh, gw, maxOrbit) {
    $("#blackhole").html("")
    ...
    var star = function() {
        ...
        var red = getRndInteger(50, 255)
        var blue = getRndInteger(50, 100)
        var green = getRndInteger(50, 100)
        stars.push(this);
    ...
    function loop() {
        ...
        context.fillStyle = 'rgba(255,255,255,0.2)'; // somewhat clear the context, this way there will be trails behind the stars 
    ...
    function updateStar() {
        var newValue = document.querySelector("#wallet-amount").value;
        for (var i = 0; i <
            newValue; i++) { // create 2500 stars
            new star();
        }
    }

    function init(time) {
        context.fillStyle = 'rgba(255,255,255,0.2)'; // Initial clear of the canvas, to avoid an issue where it all gets too dark
        context.fillRect(0, 0, cw, ch);
        for (var i = 0; i < count; i++) { // create 2500 stars
            new star();
        }
