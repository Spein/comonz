! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(require("@firebase/app")) : "function" == typeof define && define.amd ? define(["@firebase/app"], e) : e((t = t || self).firebase) }(this, function(Lh) { "use strict"; try {
        (function() { Lh = Lh && Lh.hasOwnProperty("default") ? Lh.default : Lh,
                function() { var t, u = u || {},
                        h = this;
                    ...
                    function p(t) { var e = typeof t; return "object" == e && null != t || "function" == e } var e = "closure_uid_" + (1e9 * Math.random() >>> 0),
                        r = 0;
                    ...
                    function g(e, t) { var n = Array.prototype.slice.call(arguments, 1); return function() { var t = n.slice(); return t.push.apply(t, arguments), e.apply(this, t) } } var b = Date.now || function() { return +new Date };
                    ...
                    function T(t) { if (Error.captureStackTrace) Error.captureStackTrace(this, T);
                    ...
                    y(T, Error), T.prototype.name = "CustomError", y(E, T), E.prototype.name = "AssertionError", k.prototype.get = function() { if (0 < this.b) { this.b--; var t = this.a;
                            this.a = t.next, t.next = null } else t = this.c(); return t }; var _ = new k(function() { return new O }, function(t) { t.reset() });

                    function O() { this.next = this.b = this.a = null }
                    N.prototype.add = function(t, e) { var n = _.get();
                        n.set(t, e), this.b ? this.b.next = n : this.a = n, this.b = n }, O.prototype.set = function(t, e) { this.a = t, this.b = e, this.next = null }, O.prototype.reset = function() { this.next = this.b = this.a = null }; var P = Array.prototype.indexOf ? function(t, e) { return Array.prototype.indexOf.call(t, e, void 0) } : function(t, e) { if (c(t)) return c(e) && 1 == e.length ? t.indexOf(e, 0) : -1; for (var n = 0; n < t.length; n++)
                            ...
                            return -1 },
                        R = Array.prototype.forEach ? function(t, e, n) { Array.prototype.forEach.call(t, e, n) } : function(t, e, n) { for (var i = t.length, r = c(t) ? t.split("") : t, o = 0; o < i; o++) o in r && e.call(n, r[o], o, t) }; var D = Array.prototype.map ? function(t, e) { return Array.prototype.map.call(t, e, void 0) } : function(t, e) { for (var n = t.length, i = Array(n), r = c(t) ? t.split("") : t, o = 0; o < n; o++) o in r && (i[o] = e.call(void 0, r[o], o, t)); return i },
                        C = Array.prototype.some ? function(t, e) { return Array.prototype.some.call(t, e, void 0) } : function(t, e) { for (var n = t.length, i = c(t) ? t.split("") : t, r = 0; r < n; r++)
                    ...
                    function M(n, i) {! function(t, e) { var n = t.length,
                                i = c(t) ? t.split("") : t; for (--n; 0 <= n; --n) n in i && e.call(void 0, i[n], n, t) }(n, function(t, e) { i.call(void 0, t, e, n) && 1 == Array.prototype.splice.call(n, e, 1).length && 0 }) }
                    ...
                    function V(t, e) { for (var n = t.split("%s"), i = "", r = Array.prototype.slice.call(arguments, 1); r.length && 1 < n.length;) i += n.shift() + r.shift(); return i + n.join("%s") } var K = String.prototype.trim ? function(t) { return t.trim() } : function(t) { return /^[\s\xa0]*([\s\S]*?)[\s\xa0]*$/.exec(t)[1] };

                    function F(t) { return z.test(t) && (-1 != t.indexOf("&") && (t = t.replace(H, "&amp;")), -1 != t.indexOf("<") && (t = t.replace(W, "&lt;")), -1 != t.indexOf(">") && (t = t.replace(B, "&gt;")), -1 != t.indexOf('"') && (t = t.replace(G, "&quot;")), -1 != t.indexOf("'") && (t = t.replace(X, "&#39;")), -1 != t.indexOf("\0") && (t = t.replace(J, "&#0;"))), t } var q, H = /&/g,
                        W = /</g,
                        B = />/g,
                        G = /"/g,
                        X = /'/g,
                    ...
                    t: { var Z = h.navigator; if (Z) { var Q = Z.userAgent; if (Q) { q = Q; break t } }
                        q = "" }
                    ...
                    function it(t) { var e, n = {}; for (e in t) n[e] = t[e]; return n } var rt, ot, at = "constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");
                    ...
                    function ct(t, e) { ot || function() { if (h.Promise && h.Promise.resolve) { var t = h.Promise.resolve(void 0);
                                ot = function() { t.then(ft) } } else ot = function() { var t = ft;!a(h.setImmediate) || h.Window && h.Window.prototype && !tt("Edge") && h.Window.prototype.setImmediate == h.setImmediate ? (rt || (rt = function() { var t = h.MessageChannel; if (void 0 === t && "undefined" != typeof window && window.postMessage && window.addEventListener && !tt("Presto") && (t = function() { var t = document.createElement("IFRAME");
                                        ...
                                        n = {},
                                        i = n; return e.port1.onmessage = function() { if (void 0 !== n.next) { var t = (n = n.next).wb;
                                                n.wb = null, t() } },
                                        function(t) { i.next = { wb: t }, i = i.next, e.port2.postMessage(0) } }()), rt(t)) : h.setImmediate(t) } }(), ht || (ot(), ht = !0), lt.add(t, e) } var ht = !1,
                        lt = new N;
                    ...
                    function dt(t, e) { if (this.a = pt, this.i = void 0, this.f = this.b = this.c = null, this.g = this.h = !1, t != o) try { var n = this;
                            t.call(e, function(t) { St(n, vt, t) }, function(t) { if (!(t instanceof Ct)) try { if (t instanceof Error) throw t; throw Error("Promise rejected.") } catch (t) {}
                                St(n, mt, t) }) } catch (t) { St(this, mt, t) } } var pt = 0,
                        vt = 2,
                        mt = 3;

                    function gt() { this.next = this.f = this.b = this.g = this.a = null, this.c = !1 }
                    gt.prototype.reset = function() { this.f = this.b = this.g = this.a = null, this.c = !1 }; var bt = new k(function() { return new gt }, function(t) { t.reset() });
                    ...
                    function Et(n) { return new dt(function(i) { var r = n.length,
                                o = []; if (r)
                    ...
                    function kt(t, r, o, a) { var e = yt(null, null, null); return e.a = new dt(function(n, i) { e.g = r ? function(t) { try { var e = r.call(a, t);
                                    n(e) } catch (t) { i(t) } } : n, e.b = o ? function(t) { try { var e = o.call(a, t);
                                    void 0 === e && t instanceof Ct ? i(t) : n(e) } catch (t) { i(t) } } : i }), At(e.a.c = t, e), e.a }

                    function St(t, e, n) { var i, r;
                    ...
                    function Nt(t, e, n, i) { if (t instanceof dt) return At(t, yt(e || o, n || null, i)), !0; if (I(t)) return t.then(e, n, i), !0; if (p(t)) try { var r = t.then; if (a(r)) return function(t, e, n, i, r) {
                    ...
                    function Pt(t, e, n, i) { if (n == mt && e.b && !e.c)
                            for (; t && t.g; t = t.c) t.g = !1; if (e.a) e.a.c = null, Rt(e, n, i);
                        else try { e.c ? e.g.call(e.f) : Rt(e, n, i) } catch (t) { Dt.call(null, t) }
                        S(bt, e) }

                    function Rt(t, e, n) { e == vt ? t.g.call(t.f, n) : t.b && t.b.call(t.f, n) }
                    dt.prototype.then = function(t, e, n) { return kt(this, a(t) ? t : null, a(e) ? e : null, n) }, w(dt), (t = dt.prototype).ia = function(t, e) { return (t = yt(t, t, e)).c = !0, At(this, t), this }, t.s = function(t, e) { return kt(this, null, t, e) }, t.cancel = function(t) { this.a == pt && ct(function() {! function t(e, n) { if (e.a == pt)
                                    if (e.c) { var i = e.c; if (i.b) { for (var r = 0, o = null, a = null, s = i.b; s && (s.c || (r++, s.a == e && (o = s), !(o && 1 < r))); s = s.next) o || (a = s);
                                        ...
                                        e.c = null } else St(e, mt, n) }(this, new Ct(t)) }, this) }, t.Nc = function(t) { this.a = pt, St(this, vt, t) }, t.Oc = function(t) { this.a = pt, St(this, mt, t) }, t.Yb = function() { for (var t; t = Ot(this);) Pt(this, t, this.a, this.i);
                        this.h = !1 }; var Dt = ut;
                    ...
                    Lt.prototype.qa = !(Ct.prototype.name = "cancel"), Lt.prototype.va = function() { if (this.ja)
                            for (; this.ja.length;) this.ja.shift()() }, jt[" "] = o; var Ut, Vt, Kt = tt("Opera"),
                    ...
                    t: { var Xt = "",
                            Jt = (Vt = q, Wt ? /rv:([^\);]+)(\)|;)/.exec(Vt) : qt ? /Edge\/([\d\.]+)/.exec(Vt) : Ft ? /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(Vt) : Bt ? /WebKit\/(\S+)/.exec(Vt) : Kt ? /(?:Version)[ \/]?(\S+)/.exec(Vt) : void 0); if (Jt && (Xt = Jt ? Jt[1] : ""), Ft) { var zt = Gt(); if (null != zt && zt > parseFloat(Xt)) { Ut = String(zt); break t } }
                        Ut = Xt }
                    var Yt, $t = {};

                    function Zt(s) { return t = s, e = function() { for (var t = 0, e = K(String(Ut)).split("."), n = K(String(s)).split("."), i = Math.max(e.length, n.length), r = 0; 0 == t && r < i; r++) { var o = e[r] || "",
                                    a = n[r] || "";
                                do { if (o = /(\d*)(\D*)(.*)/.exec(o) || ["", "", "", ""], a = /(\d*)(\D*)(.*)/.exec(a) || ["", "", "", ""], 0 == o[0].length && 0 == a[0].length) break;
                                    t = $(0 == o[1].length ? 0 : parseInt(o[1], 10), 0 == a[1].length ? 0 : parseInt(a[1], 10)) || $(0 == o[2].length, 0 == a[2].length) || $(o[2], a[2]), o = o[3], a = a[3] } while (0 == t) } return 0 <= t }, n = $t, Object.prototype.hasOwnProperty.call(n, t) ? n[t] : n[t] = e(t); var t, e, n } var Qt = h.document;
                    Yt = Qt && Ft ? Gt() || ("CSS1Compat" == Qt.compatMode ? parseInt(Ut, 10) : 5) : void 0; var te = Object.freeze || function(t) { return t },
                        ee = !Ft || 9 <= Number(Yt),
                        ne = Ft && !Zt("9"),
                        ie = function() { if (!h.addEventListener || !Object.defineProperty) return !1; var t = !1,
                    ...
                    function oe(t, e) { if (re.call(this, t ? t.type : ""), this.relatedTarget = this.b = this.target = null, this.button = this.screenY = this.screenX = this.clientY = this.clientX = 0, this.key = "", this.metaKey = this.shiftKey = this.altKey = this.ctrlKey = !1, this.pointerId = 0, this.pointerType = "", this.a = null, t) { var n = this.type = t.type,
                                i = t.changedTouches ? t.changedTouches[0] : null; if (this.target = t.target || t.srcElement, this.b = e, e = t.relatedTarget) { if (Wt) { t: { try { jt(e.nodeName); var r = !0; break t } catch (t) {}
                                        r = !1 }
                    ...
                    re.prototype.preventDefault = function() { this.Kb = !1 }, y(oe, re); var ae = te({ 2: "touch", 3: "pen", 4: "mouse" });
                    ...
                    le.prototype.add = function(t, e, n, i, r) { var o = t.toString();
                        (t = this.a[o]) || (t = this.a[o] = [], this.b++); var a = de(t, e, i, r); return -1 < a ? (e = t[a], n || (e.Ia = !1)) : ((e = new ce(e, this.src, o, !!i, r)).Ia = n, t.push(e)), e }; var pe = "closure_lm_" + (1e6 * Math.random() | 0),
                        ve = {};

                    function me(t, e, n, i, r) { if (i && i.once) be(t, e, n, i, r);
                        else if (f(e))
                            for (var o = 0; o < e.length; o++) me(t, e[o], n, i, r);
                        else n = Ne(n), t && t[se] ? Oe(t, e, n, p(i) ? !!i.capture : !!i, r) : ge(t, e, n, !1, i, r) }

                    function ge(t, e, n, i, r, o) { if (!e) throw Error("Invalid event type"); var a, s, u = p(r) ? !!r.capture : !!r,
                            c = ke(t); if (c || (t[pe] = c = new le(t)), !(n = c.add(e, n, i, u, o)).proxy)
                    ...
                    function we(t) { if ("number" != typeof t && t && !t.oa) { var e = t.src; if (e && e[se]) fe(e.l, t);
                            else { var n = t.type,
                                    i = t.proxy;
                    ...
                    function Te(t, e, n, i) { var r = !0; if ((t = ke(t)) && (e = t.a[e.toString()]))
                            for (e = e.concat(), t = 0; t < e.length; t++) { var o = e[t];
                                o && o.capture == n && !o.oa && (o = Ee(o, i), r = r && !1 !== o) }
                        return r }

                    function Ee(t, e) { var n = t.listener,
                            i = t.La || t.src; return t.Ia && we(t), n.call(i, e) }

                    function Ae(t, e) { if (t.oa) return !0; if (ee) return Ee(t, new oe(e, this)); if (!e) t: { e = ["window", "event"]; for (var n = h, i = 0; i < e.length; i++)
                                if (null == (n = n[e[i]])) { e = null; break t }
                            e = n }
                        if (e = new oe(i = e, this), n = !0, !(i.keyCode < 0 || null != i.returnValue)) { t: { var r = !1; if (0 == i.keyCode) try { i.keyCode = -1; break t } catch (t) { r = !0 }(r || null == i.returnValue) && (i.returnValue = !0) } for (i = [], r = e.b; r; r = r.parentNode) i.push(r); for (t = t.type, r = i.length - 1; 0 <= r; r--) { e.b = i[r]; var o = Te(i[r], t, !0, e);
                                n = n && o } for (r = 0; r < i.length; r++) e.b = i[r], o = Te(i[r], t, !1, e), n = n && o } return n }

                    function ke(t) { return (t = t[pe]) instanceof le ? t : null } var Se = "__closure_events_fn_" + (1e9 * Math.random() >>> 0);
                    ...
                    function Re(t, e, n, i) { if (!(e = t.l.a[String(e)])) return !0;
                        e = e.concat(); for (var r = !0, o = 0; o < e.length; ++o) { var a = e[o]; if (a && !a.oa && a.capture == n) { var s = a.listener,
                                    u = a.La || a.src;
                                a.Ia && fe(t.l, a), r = !1 !== s.call(u, i) && r } } return r && 0 != i.Kb }

                    function De(t, e, n) { if (a(t)) n && (t = m(t, n));
                    ...
                    function xe(t) { if (t.U && "function" == typeof t.U) return t.U(); if (!t.S || "function" != typeof t.S) { if (d(t) || c(t)) { var e = [];
                                t = t.length; for (var n = 0; n < t; n++) e.push(n); return e } for (var i in e = [], n = 0, t) e[n++] = i; return e } }

                    function Me(t, e) { this.b = {}, this.a = [], this.c = 0; var n = arguments.length; if (1 < n) { if (n % 2) throw Error("Uneven number of arguments"); for (var i = 0; i < n; i += 2) this.set(arguments[i], arguments[i + 1]) } else if (t)
                            if (t instanceof Me)
                                for (n = t.U(), i = 0; i < n.length; i++) this.set(n[i], t.get(n[i]));
                            else
                                for (i in t) this.set(i, t[i]) }

                    function je(t) { if (t.c != t.a.length) { for (var e = 0, n = 0; e < t.a.length;) { var i = t.a[e];
                                Ue(t.b, i) && (t.a[n++] = i), e++ }
                            t.a.length = n } if (t.c != t.a.length) { var r = {}; for (n = e = 0; e < t.a.length;) Ue(r, i = t.a[e]) || (r[t.a[n++] = i] = 1), e++;
                            t.a.length = n } }

                    function Ue(t, e) { return Object.prototype.hasOwnProperty.call(t, e) }
                    y(_e, Lt), _e.prototype[se] = !0, _e.prototype.addEventListener = function(t, e, n, i) { me(this, t, e, n, i) }, _e.prototype.removeEventListener = function(t, e, n, i) { ye(this, t, e, n, i) }, _e.prototype.dispatchEvent = function(t) { var e, n = this.Va; if (n)
                            for (e = []; n; n = n.Va) e.push(n);
                        n = this.Rb; var i = t.type || t; if (c(t)) t = new re(t, n);
                        else if (t instanceof re) t.target = t.target || n;
                        else { var r = t;
                            st(t = new re(i, n), r) } if (r = !0, e)
                            for (var o = e.length - 1; 0 <= o; o--) { var a = t.b = e[o];
                                r = Re(a, i, !0, t) && r }
                        if (r = Re(a = t.b = n, i, !0, t) && r, r = Re(a, i, !1, t) && r, e)
                            for (o = 0; o < e.length; o++) r = Re(a = t.b = e[o], i, !1, t) && r; return r }, _e.prototype.va = function() { if (_e.ob.va.call(this), this.l) { var t, e = this.l; for (t in e.a) { for (var n = e.a[t], i = 0; i < n.length; i++) he(n[i]);
                                delete e.a[t], e.b-- } }
                        this.Va = null }, (t = Me.prototype).S = function() { je(this); for (var t = [], e = 0; e < this.a.length; e++) t.push(this.b[this.a[e]]); return t }, t.U = function() { return je(this), this.a.concat() }, t.clear = function() { this.b = {}, this.c = this.a.length = 0 }, t.get = function(t, e) { return Ue(this.b, t) ? this.b[t] : e }, t.set = function(t, e) { Ue(this.b, t) || (this.c++, this.a.push(t)), this.b[t] = e }, t.forEach = function(t, e) { for (var n = this.U(), i = 0; i < n.length; i++) { var r = n[i],
                                o = this.get(r);
                            t.call(e, o, r, this) } }; var Ve = /^(?:([^:/?#.]+):)?(?:\/\/(?:([^/?#]*)@)?([^/#?]*?)(?::([0-9]+))?(?=[/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/;

                    function Ke(t, e) { if (this.b = this.l = this.c = "", this.i = null, this.h = this.g = "", this.f = !1, t instanceof Ke) { this.f = void 0 !== e ? e : t.f, Fe(this, t.c), this.l = t.l, this.b = t.b, qe(this, t.i), this.g = t.g, e = t.a; var n = new nn;
                            n.c = e.c, e.a && (n.a = new Me(e.a), n.b = e.b), He(this, n), this.h = t.h } else t && (n = String(t).match(Ve)) ? (this.f = !!e, Fe(this, n[1] || "", !0), this.l = Je(n[2] || ""), this.b = Je(n[3] || "", !0), qe(this, n[4]), this.g = Je(n[5] || "", !0), He(this, n[6] || "", !0), this.h = Je(n[7] || "")) : (this.f = !!e, this.a = new nn(null, this.f)) }

                    function Fe(t, e, n) { t.c = n ? Je(e, !0) : e, t.c && (t.c = t.c.replace(/:$/, "")) }

                    function qe(t, e) { if (e) { if (e = Number(e), isNaN(e) || e < 0) throw Error("Bad port number " + e);
                            t.i = e } else t.i = null }

                    function He(t, e, n) { var i, r;
                        e instanceof nn ? (t.a = e, i = t.a, (r = t.f) && !i.f && (rn(i), i.c = null, i.a.forEach(function(t, e) { var n = e.toLowerCase();
                            e != n && (an(this, e), un(this, n, t)) }, i)), i.f = r) : (n || (e = ze(e, tn)), t.a = new nn(e, t.f)) }
                    ...
                    Ke.prototype.toString = function() { var t = [],
                            e = this.c;
                    ...
                    function rn(n) { n.a || (n.a = new Me, n.b = 0, n.c && function(t, e) { if (t) { t = t.split("&"); for (var n = 0; n < t.length; n++) { var i = t[n].indexOf("="),
                                        r = null; if (0 <= i) { var o = t[n].substring(0, i);
                                        r = t[n].substring(i + 1) } else o = t[n];
                                    e(o, r ? decodeURIComponent(r.replace(/\+/g, " ")) : "") } } }(n.c, function(t, e) { n.add(decodeURIComponent(t.replace(/\+/g, " ")), e) })) }

                    function on(t) { var e = xe(t); if (void 0 === e) throw Error("Keys are undefined"); var n = new nn(null, void 0);
                        t = Le(t); for (var i = 0; i < e.length; i++) { var r = e[i],
                                o = t[i];
                            f(o) ? un(n, r, o) : n.add(r, o) } return n }
                    ...
                    function cn(t, e) { return e = String(e), t.f && (e = e.toLowerCase()), e }(t = nn.prototype).add = function(t, e) { rn(this), this.c = null, t = cn(this, t); var n = this.a.get(t); return n || this.a.set(t, n = []), n.push(e), this.b += 1, this }, t.clear = function() { this.a = this.c = null, this.b = 0 }, t.forEach = function(n, i) { rn(this), this.a.forEach(function(t, e) { R(t, function(t) { n.call(i, t, e, this) }, this) }, this) }, t.U = function() { rn(this); for (var t = this.a.S(), e = this.a.U(), n = [], i = 0; i < e.length; i++)
                            for (var r = t[i], o = 0; o < r.length; o++) n.push(e[i]); return n }, t.S = function(t) { rn(this); var e = []; if (c(t)) sn(this, t) && (e = j(e, this.a.get(cn(this, t))));
                        else { t = this.a.S(); for (var n = 0; n < t.length; n++) e = j(e, t[n]) } return e }, t.set = function(t, e) { return rn(this), this.c = null, sn(this, t = cn(this, t)) && (this.b -= this.a.get(t).length), this.a.set(t, [e]), this.b += 1, this }, t.get = function(t, e) { return 0 < (t = t ? this.S(t) : []).length ? String(t[0]) : e }, t.toString = function() { if (this.c) return this.c; if (!this.a) return ""; for (var t = [], e = this.a.U(), n = 0; n < e.length; n++) { var i = e[n],
                                r = encodeURIComponent(String(i));
                            i = this.S(i); for (var o = 0; o < i.length; o++) { var a = r; "" !== i[o] && (a += "=" + encodeURIComponent(String(i[o]))), t.push(a) } } return this.c = t.join("&") }; var hn = !Ft || 9 <= Number(Yt);
                    ...
                    ln.prototype.na = !0, ln.prototype.ma = function() { return this.a }, ln.prototype.toString = function() { return "Const{" + this.a + "}" }; var dn = {};
                    ...
                    pn(""), vn.prototype.na = !0, vn.prototype.ma = function() { return this.a }, vn.prototype.toString = function() { return "TrustedResourceUrl{" + this.a + "}" }; var bn = /%{(\w+)}/g,
                    ...
                    In.prototype.na = !0, In.prototype.ma = function() { return this.a }, In.prototype.toString = function() { return "SafeUrl{" + this.a + "}" }; var En = /^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;

                    function An(t) { return t instanceof In ? t : (t = t.na ? t.ma() : String(t), En.test(t) || (t = "about:invalid#zClosurez"), Sn(t)) } var kn = {};

                    function Sn(t) { var e = new In; return e.a = t, e }

                    function Nn() { this.a = "", this.b = _n }
                    Sn("about:blank"), Nn.prototype.na = !0, Nn.prototype.ma = function() { return this.a }, Nn.prototype.toString = function() { return "SafeHtml{" + this.a + "}" }; var _n = {};
                    ...
                    On("<!DOCTYPE html>"), On(""), On("<br>"); var Dn = { cellpadding: "cellPadding", cellspacing: "cellSpacing", colspan: "colSpan", frameborder: "frameBorder", height: "height", maxlength: "maxLength", nonce: "nonce", role: "role", rowspan: "rowSpan", type: "type", usemap: "useMap", valign: "vAlign", width: "width" };

                    function Cn(t, e, n) { var i = arguments,
                            r = document,
                            o = String(i[0]),
                            a = i[1]; if (!hn && a && (a.name || a.type)) { if (o = ["<", o], a.name && o.push(' name="', F(a.name), '"'), a.type) { o.push(' type="', F(a.type), '"'); var s = {};
                                st(s, a), delete s.type, a = s }
                            o.push(">"), o = o.join("") } return o = r.createElement(o), a && (c(a) ? o.className = a : f(a) ? o.className = a.join(" ") : Rn(o, a)), 2 < i.length && function(e, n, t) {
                            function i(t) { t && n.appendChild(c(t) ? e.createTextNode(t) : t) } for (var r = 2; r < t.length; r++) { var o = t[r];!d(o) || p(o) && 0 < o.nodeType ? i(o) : R(Ln(o) ? U(o) : o, i) } }(r, o, i), o }
                    ...
                    function xn(t) { var e = []; return function t(e, n, i) { if (null == n) i.push("null");
                            else { if ("object" == typeof n) { if (f(n)) { var r = n;
                                        n = r.length, i.push("["); for (var o = "", a = 0; a < n; a++) i.push(o), t(e, r[a], i), o = ","; return void i.push("]") } if (!(n instanceof String || n instanceof Number || n instanceof Boolean)) { for (r in i.push("{"), o = "", n) Object.prototype.hasOwnProperty.call(n, r) && ("function" != typeof(a = n[r]) && (i.push(o), Vn(r, i), i.push(":"), t(e, a, i), o = ",")); return void i.push("}") }
                                    ...
                                    case "function":
                                        i.push("null"); break;
                                    default:
                                        throw Error("Unknown type: " + typeof n) } } }(new Mn, t, e), e.join("") }

                    function Mn() {} var jn = { '"': '\\"', "\\": "\\\\", "/": "\\/", "\b": "\\b", "\f": "\\f", "\n": "\\n", "\r": "\\r", "\t": "\\t", "\v": "\\u000b" },
                    ...
                    function qn(t, e) { e = e || h.window; var n = "about:blank";
                    ...
                    function Bn(t, e, n) { var i = Math.floor(1e9 * Math.random()).toString();
                        e = e || 500, n = n || 600; var r = (window.screen.availHeight - n) / 2,
                            o = (window.screen.availWidth - e) / 2; for (s in e = { width: e, height: n, top: 0 < r ? r : 0, left: 0 < o ? o : 0, location: !0, resizable: !0, statusbar: !0, toolbar: !1 }, n = oi().toLowerCase(), i && (e.target = i, Y(n, "crios/") && (e.target = "_blank")), ni(oi()) == ti && (t = t || "http://localhost", e.scrollbars = !0), n = t || "", (t = e) || (t = {}), i = window, e = n instanceof In ? n : An(void 0 !== n.href ? n.href : String(n)), n = t.target || n.target, r = [], t) switch (s) {
                            case "width":
                            case "height":
                            case "top":
                            case "left":
                    ...
                    function si() { try { var t = h.localStorage,
                                e = vi(); if (t) return t.setItem(e, "1"), t.removeItem(e), !Kn() || !!h.indexedDB } catch (t) { return $n() && !!h.indexedDB } return !1 }
                    ...
                    function gi() { var t = h.___jsl; if (t && t.H)
                            for (var e in t.H)
                                if (t.H[e].r = t.H[e].r || [], t.H[e].L = t.H[e].L || [], t.H[e].r = t.H[e].L.concat(), t.CP)
                                    for (var n = 0; n < t.CP.length; n++) t.CP[n] = null }

                    function bi(t, e) { if (e < t) throw Error("Short delay should be less than long delay!");
                    ...
                    bi.prototype.get = function() { var t = h.navigator; return !t || "boolean" != typeof t.onLine || !ci() && "chrome-extension:" !== hi() && void 0 === t.connection || t.onLine ? this.b ? this.c : this.a : Math.min(5e3, this.a) }; var Ti, Ei = {};

                    function Ai(t) { Ei[t] || (Ei[t] = !0, "undefined" != typeof console && "function" == typeof console.warn && console.warn(t)) } try { var ki = {};
                        Object.defineProperty(ki, "abcd", { configurable: !0, enumerable: !0, value: 1 }), Object.defineProperty(ki, "abcd", { configurable: !0, enumerable: !0, value: 2 }), Ti = 2 == ki.abcd } catch (t) { Ti = !1 }
                    ...
                    function Oi(t) { var e = t; if ("object" == typeof t && null != t)
                            for (var n in e = "length" in t ? [] : {}, t) Si(e, n, Oi(t[n])); return e }

                    function Pi(t) { var e = {},
                            n = t[Di],
                            i = t[Ci]; if (!(t = t[Li]) || t != Ri && !n) throw Error("Invalid provider user info!");
                        e[Mi] = i || null, e[xi] = n || null, Si(this, Ui, t), Si(this, ji, Oi(e)) } var Ri = "EMAIL_SIGNIN",
                        Di = "email",
                        Ci = "newEmail",
                        Li = "requestType",
                        xi = "email",
                    ...
                    y(Vi, Error), Vi.prototype.C = function() { return { code: this.code, message: this.message } }, Vi.prototype.toJSON = function() { return this.C() }; var Fi = "auth/",
                    ...
                    function Hi(t) { var e = t[Ji]; if (void 0 === e) throw new Vi("missing-continue-uri"); if ("string" != typeof e || "string" == typeof e && !e.length) throw new Vi("invalid-continue-uri");
                        this.h = e, this.b = this.a = null, this.g = !1; var n = t[Wi]; if (n && "object" == typeof n) { e = n[$i]; var i = n[zi]; if (n = n[Yi], "string" == typeof e && e.length) { if (this.a = e, void 0 !== i && "boolean" != typeof i) throw new Vi("argument-error", zi + " property must be a boolean when specified."); if (this.g = !!i, void 0 !== n && ("string" != typeof n || "string" == typeof n && !n.length)) throw new Vi("argument-error", Yi + " property must be a non empty string when specified.");
                                this.b = n || null } else { if (void 0 !== e) throw new Vi("argument-error", $i + " property must be a non empty string when specified."); if (void 0 !== i || void 0 !== n) throw new Vi("missing-android-pkg-name") } } else if (void 0 !== n) throw new Vi("argument-error", Wi + " property must be a non null object when specified."); if (this.f = null, (e = t[Xi]) && "object" == typeof e) { if ("string" == typeof(e = e[Zi]) && e.length) this.f = e;
                            else if (void 0 !== e) throw new Vi("argument-error", Zi + " property must be a non empty string when specified.") } else if (void 0 !== e) throw new Vi("argument-error", Xi + " property must be a non null object when specified."); if (void 0 !== (e = t[Gi]) && "boolean" != typeof e) throw new Vi("argument-error", Gi + " property must be a boolean when specified."); if (this.c = !!e, void 0 !== (t = t[Bi]) && ("string" != typeof t || "string" == typeof t && !t.length)) throw new Vi("argument-error", Bi + " property must be a non empty string when specified.");
                        this.i = t || null } var Wi = "android",
                    ...
                    function Qi(t) { var e = {}; for (var n in e.continueUrl = t.h, e.canHandleCodeInApp = t.c, (e.androidPackageName = t.a) && (e.androidMinimumVersion = t.b, e.androidInstallApp = t.g), e.iOSBundleId = t.f, e.dynamicLinkDomain = t.i, e) null === e[n] && delete e[n]; return e } var tr = null,
                        er = null;

                    function nr(t) { var e = ""; return function(i, t) {
                            function e(t) { for (; r < i.length;) { var e = i.charAt(r++),
                                        n = er[e]; if (null != n) return n; if (!/^[\s\xa0]*$/.test(e)) throw Error("Unknown base64 encoding at char: " + e) } return t }! function() { if (!tr) { tr = {}, er = {}; for (var t = 0; t < 65; t++) tr[t] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(t), 62 <= (er[tr[t]] = t) && (er["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(t)] = t) } }(); for (var r = 0;;) { var n = e(-1),
                                    o = e(0),
                                    a = e(64),
                    ...
                    function fr(t) { for (var e in lr)
                            if (lr[e].Na == t) return lr[e];
                        return null }

                    function dr(t) { var e = {};
                        e["facebook.com"] = br, e["google.com"] = wr, e["github.com"] = yr, e["twitter.com"] = Ir; var n = t && t[vr]; try { if (n) return e[n] ? new e[n](t) : new gr(t); if (void 0 !== t[pr]) return new mr(t) } catch (t) {} return null } var pr = "idToken",
                        vr = "providerId";

                    function mr(t) { var e = t[vr]; if (!e && t[pr]) { var n = rr(t[pr]);
                    ...
                    function yr(t) { if (gr.call(this, t), "github.com" != this.providerId) throw Error("Invalid provider ID!");
                    ...
                    function Ir(t) { if (gr.call(this, t), "twitter.com" != this.providerId) throw Error("Invalid provider ID!");
                        Si(this, "username", t.screenName || null) }

                    function Tr(t) { this.a = Ge(t) }

                    function Er(t) { var e = Ge(t),
                            n = Be(e, "link"),
                            i = Be(Ge(n), "link"); return Be(Ge(e = Be(e, "deep_link_id")), "link") || e || i || n || t }
                    ...
                    function kr(t, e) { if (!e) throw new Vi("internal-error", "failed to construct a credential");
                        this.a = e, Si(this, "providerId", t), Si(this, "signInMethod", t) }

                    function Sr(t) { return { pendingToken: t.a, requestUri: "http://localhost" } }

                    function Nr(t, e, n) { if (this.a = null, e.idToken || e.accessToken) e.idToken && Si(this, "idToken", e.idToken), e.accessToken && Si(this, "accessToken", e.accessToken), e.nonce && !e.pendingToken && Si(this, "nonce", e.nonce), e.pendingToken && (this.a = e.pendingToken);
                        else { if (!e.oauthToken || !e.oauthTokenSecret) throw new Vi("internal-error", "failed to construct a credential");
                    ...
                    function Pr(t) { if ("string" != typeof t || 0 != t.indexOf("saml.")) throw new Vi("argument-error", 'SAML provider IDs must be prefixed with "saml."');
                        Or.call(this, t, []) }
                    ...
                    function Wr(t) { if (!(t.Ta && t.Sa || t.Fa && t.$)) throw new Vi("internal-error");
                    ...
                    function Gr(t) { try { this.a = t || Lh.auth() } catch (t) { throw new Vi("argument-error", "Either an instance of firebase.auth.Auth must be passed as an argument to the firebase.auth.PhoneAuthProvider constructor, or the default firebase App instance must be initialized via firebase.initializeApp().") }
                    ...
                    function Jr(t) { if (t.temporaryProof && t.phoneNumber) return new Wr({ Fa: t.temporaryProof, $: t.phoneNumber }); var e = t && t.providerId; if (!e || "password" === e) return null; var n = t && t.oauthAccessToken,
                            ...
                            a = t && t.pendingToken; try { switch (e) {
                                ...
                                case "twitter.com":
                                    return Vr(n, i);
                                default:
                                    return n || i || o || a ? a ? 0 == e.indexOf("saml.") ? new kr(e, a) : new Nr(e, { pendingToken: a, idToken: t.oauthIdToken, accessToken: t.oauthAccessToken }, e) : new Rr(e).credential(o, n, r) : null } } catch (t) { return null } }
                    ...
                    function io(t) { if (t.code) { var e = t.code || "";
                            0 == e.indexOf(Fi) && (e = e.substring(Fi.length)); var n = { credential: Jr(t) }; if (t.email) n.zb = t.email;
                            else if (t.phoneNumber) n.$ = t.phoneNumber;
                            else if (!n.credential) return new Vi(e, t.message || void 0); return new no(e, n, t.message) } return null }
                    ...
                    Zr.prototype.subscribe = function(t) { var n = this;
                        this.a.push(t), this.b || (this.b = function(t) { for (var e = 0; e < n.a.length; e++) n.a[e](t) }, "function" == typeof(t = ai("universalLinks.subscribe", h)) && t(null, this.b)) }, Zr.prototype.unsubscribe = function(e) { M(this.a, function(t) { return t == e }) }, y(eo, Vi), y(no, Vi), no.prototype.C = function() { var t = { code: this.code, message: this.message };
                        ...
                        this.a.open(t, e) }, t.send = function(t) { if (t) { if ("string" != typeof t) throw Error("Only string data is supported");
                            this.a.send(t) } else this.a.send() }, t.abort = function() { this.a.abort() }, t.setRequestHeader = function() {}, t.getResponseHeader = function(t) { return "content-type" == t.toLowerCase() ? this.a.contentType : "" }, t.ec = function() { this.status = 200, this.responseText = this.a.responseText, ho(this, 4) }, t.Fb = function() { this.status = 500, this.responseText = "", ho(this, 4) }, t.ic = function() { this.Fb() }, t.fc = function() { this.status = 200, ho(this, 1) }, t.getAllResponseHeaders = function() { return "content-type: " + this.a.contentType }, lo.prototype.a = null, lo.prototype.reset = function(t, e, n, i, r) { delete this.a }, po.prototype.toString = function() { return this.name }; var vo = new po("SEVERE", 1e3),
                        mo = new po("WARNING", 900),
                        go = new po("CONFIG", 700),
                        bo = new po("FINE", 500);
                    fo.prototype.log = function(t, e, n) { if (t.value >= function t(e) { return e.c ? e.c : e.a ? t(e.a) : (A("Root logger has no level set."), null) }(this).value)
                            for (a(e) && (e = e()), t = new lo(t, String(e), this.f), n && (t.a = n), n = this; n;) n = n.a }; var yo, wo = {},
                        Io = null;

                    function To(t) { var e; if (Io || (Io = new fo(""), (wo[""] = Io).c = go), !(e = wo[t])) { e = new fo(t); var n = t.lastIndexOf("."),
                                i = t.substr(n + 1);
                            (n = To(t.substr(0, n))).b || (n.b = {}), (n.b[i] = e).a = n, wo[t] = e } return e }
                    ...
                    y(Ao, ro), Ao.prototype.a = function() { return new ko(this.f) }, Ao.prototype.b = (yo = {}, function() { return yo }), y(ko, _e); var So = 0;

                    function No(t) { t.onreadystatechange && t.onreadystatechange.call(t) }

                    function _o(t) { _e.call(this), this.headers = new Me, this.D = t || null, this.c = !1, this.w = this.a = null, this.h = this.N = this.m = "", this.f = this.I = this.i = this.G = !1, this.g = 0, this.u = null, this.o = Oo, this.v = this.O = !1 }(t = ko.prototype).open = function(t, e) { if (this.readyState != So) throw this.abort(), Error("Error reopening a connection");
                    ...
                    _o.prototype.b = To("goog.net.XhrIo"); var Po = /^https?$/i,
                        Ro = ["POST", "PUT"];

                    function Do(e, t, n, i, r) { if (e.a) throw Error("[goog.net.XhrIo] Object is active with another request=" + e.m + "; newUri=" + t);
                        n = n ? n.toUpperCase() : "GET", e.m = t, e.h = "", e.N = n, e.G = !1, e.c = !0, e.a = e.D ? e.D.a() : Qr.a(), e.w = e.D ? oo(e.D) : oo(Qr), e.a.onreadystatechange = m(e.Jb, e); try { Eo(e.b, Fo(e, "Opening Xhr")), e.I = !0, e.a.open(n, String(t), !0), e.I = !1 } catch (t) { return Eo(e.b, Fo(e, "Error opening Xhr: " + t.message)), void Lo(e, t) }
                        t = i || ""; var o, a = new Me(e.headers);
                        r && function(t, e) { if (t.forEach && "function" == typeof t.forEach) t.forEach(e, void 0);
                            else if (d(t) || c(t)) R(t, e, void 0);
                            else
                                for (var n = xe(t), i = Le(t), r = i.length, o = 0; o < r; o++) e.call(void 0, i[o], n && n[o], t) }(r, function(t, e) { a.set(e, t) }), r = function(t) { t: { for (var e = Co, n = t.length, i = c(t) ? t.split("") : t, r = 0; r < n; r++)
                                    if (r in i && e.call(void 0, i[r], r, t)) { e = r; break t }
                                e = -1 } return e < 0 ? null : c(t) ? t.charAt(e) : t[e] }(a.U()), i = h.FormData && t instanceof h.FormData, !L(Ro, n) || r || i || a.set("Content-Type", "application/x-www-form-urlencoded;charset=utf-8"), a.forEach(function(t, e) { this.a.setRequestHeader(e, t) }, e), e.o && (e.a.responseType = e.o), "withCredentials" in e.a && e.a.withCredentials !== e.O && (e.a.withCredentials = e.O); try { Uo(e), 0 < e.g && (e.v = (o = e.a, Ft && Zt(9) && "number" == typeof o.timeout && void 0 !== o.ontimeout), Eo(e.b, Fo(e, "Will abort after " + e.g + "ms if incomplete, xhr2 " + e.v)), e.v ? (e.a.timeout = e.g, e.a.ontimeout = m(e.Ga, e)) : e.u = De(e.Ga, e.g, e)), Eo(e.b, Fo(e, "Sending request")), e.i = !0, e.a.send(t), e.i = !1 } catch (t) { Eo(e.b, Fo(e, "Send error: " + t.message)), Lo(e, t) } }
                    ...
                    function Mo(e) { if (e.c && void 0 !== u)
                            if (e.w[1] && 4 == Vo(e) && 2 == Ko(e)) Eo(e.b, Fo(e, "Local request error detected and ignored"));
                            else if (e.i && 4 == Vo(e)) De(e.Jb, 0, e);
                        else if (e.dispatchEvent("readystatechange"), 4 == Vo(e)) { Eo(e.b, Fo(e, "Request complete")), e.c = !1; try { var t, n = Ko(e);
                                t: switch (n) {
                                    case 200:
                                    case 201:
                                    case 202:
                                    ...
                                    default:
                                        i = !1 }
                                if (!(t = i)) { var r; if (r = 0 === n) { var o = String(e.m).match(Ve)[1] || null; if (!o && h.self && h.self.location) { var a = h.self.location.protocol;
                                            o = a.substr(0, a.length - 1) }
                                        r = !Po.test(o ? o.toLowerCase() : "") }
                                    t = r } if (t) e.dispatchEvent("complete"), e.dispatchEvent("success");
                                else { try { var s = 2 < Vo(e) ? e.a.statusText : "" } catch (t) { Eo(e.b, "Can not get status: " + t.message), s = "" }
                                    e.h = s + " [" + Ko(e) + "]", xo(e) } } finally { jo(e) } } }

                    function jo(e, t) { if (e.a) { Uo(e); var n = e.a,
                                i = e.w[0] ? o : null;
                            e.a = null, e.w = null, t || e.dispatchEvent("ready"); try { n.onreadystatechange = i } catch (t) {
                    ...
                    function Wo(t) { if (t.a) { if (!t.m) throw new Jo(t);
                            t.m = !1 } }
                    ...
                    function Xo(e) { if (e.h && e.a && Go(e)) { var n = e.h,
                                i = $o[n];
                            i && (h.clearTimeout(i.a), delete $o[n]), e.h = 0 }
                        e.b && (e.b.l--, delete e.b), n = e.c; for (var t = i = !1; e.g.length && !e.i;) { var r = e.g.shift(),
                                o = r[0],
                                a = r[1]; if (r = r[2], o = e.f ? a : o) try { var s = o.call(r || e.u, n);
                                void 0 !== s && (e.f = e.f && (s == n || s instanceof Error), e.c = n = s), (I(n) || "function" == typeof h.Promise && n instanceof h.Promise) && (t = !0, e.i = !0) } catch (t) { n = t, e.f = !0, Go(e) || (i = !0) } }
                    ...
                    function Yo(t) { this.a = h.setTimeout(m(this.c, this), 0), this.b = t }(t = _o.prototype).Ga = function() { void 0 !== u && this.a && (this.h = "Timed out after " + this.g + "ms, aborting", Eo(this.b, Fo(this, this.h)), this.dispatchEvent("timeout"), this.abort(8)) }, t.abort = function() { this.a && this.c && (Eo(this.b, Fo(this, "Aborting")), this.c = !1, this.f = !0, this.a.abort(), this.f = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), jo(this)) }, t.va = function() { this.a && (this.c && (this.c = !1, this.f = !0, this.a.abort(), this.f = !1), jo(this, !0)), _o.ob.va.call(this) }, t.Jb = function() { this.qa || (this.I || this.i || this.f ? Mo(this) : this.wc()) }, t.wc = function() { Mo(this) }, t.getResponse = function() { try { if (!this.a) return null; if ("response" in this.a) return this.a.response; switch (this.o) {
                                case Oo:
                                case "text":
                                    return this.a.responseText;
                                case "arraybuffer":
                                    if ("mozResponseArrayBuffer" in this.a) return this.a.mozResponseArrayBuffer } var t = this.b; return t && t.log(vo, "Response type " + this.o + " is not supported on this browser", void 0), null } catch (t) { return Eo(this.b, "Can not get response: " + t.message), null } }, qo.prototype.cancel = function(t) { if (this.a) this.c instanceof qo && this.c.cancel();
                        else { if (this.b) { var e = this.b;
                                delete this.b, t ? e.cancel(t) : (e.l--, e.l <= 0 && e.cancel()) }
                            this.v ? this.v.call(this.u, this) : this.m = !0, this.a || (t = new zo(this), Wo(this), Ho(this, !1, t)) } }, qo.prototype.o = function(t, e) { this.i = !1, Ho(this, t, e) }, qo.prototype.D = function() { Wo(this), Ho(this, !0, null) }, qo.prototype.then = function(t, e, n) { var i, r, o = new dt(function(t, e) { i = t, r = e }); return Bo(this, i, function(t) { t instanceof zo ? o.cancel() : r(t) }), o.then(t, e, n) }, w(qo), y(Jo, T), Jo.prototype.message = "Deferred has already fired", Jo.prototype.name = "AlreadyCalledError", y(zo, T), zo.prototype.message = "Deferred was canceled", zo.prototype.name = "CanceledError", Yo.prototype.c = function() { throw delete $o[this.a], this.b }; var $o = {};

                    function Zo(t) { var e, n, i, r = document,
                            o = mn(t),
                            a = document.createElement("SCRIPT"),
                            s = { Lb: a, Ga: void 0 },
                            u = new qo(Qo, s); return e = window.setTimeout(function() { ta(a, !0); var t = new ia(na, "Timeout reached for loading script " + o);
                            Wo(u), Ho(u, !1, t) }, 5e3), s.Ga = e, a.onload = a.onreadystatechange = function() { a.readyState && "loaded" != a.readyState && "complete" != a.readyState || (ta(a, !1, e), u.D()) }, a.onerror = function() { ta(a, !0, e); var t = new ia(ea, "Error while loading script " + o);
                            Wo(u), Ho(u, !1, t) }, st(s = {}, { type: "text/javascript", charset: "UTF-8" }), Rn(a, s), a.src = mn(t), (n = r, (i = (n || document).getElementsByTagName("HEAD")) && 0 != i.length ? i[0] : n.documentElement).appendChild(a), u }

                    function Qo() { if (this && this.Lb) { var t = this.Lb;
                    ...
                    function ia(t, e) { var n = "Jsloader error (code #" + t + ")";
                    ...
                    y(ia, T), y(ra, ro), ra.prototype.a = function() { return new this.f }, ra.prototype.b = function() { return {} }; var aa, sa = "idToken",
                        ua = new bi(3e4, 6e4),
                    ...
                    function pa(t, e, n, i, r, o, a) { var s;
                        (t = !((s = ni(s = oi()) != ei ? null : (s = s.match(/\sChrome\/(\d+)/i)) && 2 == s.length ? parseInt(s[1], 10) : null) && s < 30 || Ft && Yt && !(9 < Yt)) || $n() ? m(t.o, t) : (aa || (aa = new dt(function(t, e) {! function(t, e) { if (((window.gapi || {}).client || {}).request) t();
                                else { h[ma] = function() {
                                        ((window.gapi || {}).client || {}).request ? t() : e(Error("CORS_UNSUPPORTED")) }; var n = gn(va, { onload: ma });
                                    Bo(Zo(n), null, function() { e(Error("CORS_UNSUPPORTED")) }, void 0) } }(t, e) })), m(t.m, t)))(e, n, i, r, o, a) }
                    oa.prototype.o = function(t, n, e, i, r, o) { if ($n() && (void 0 === h.fetch || void 0 === h.Headers || void 0 === h.Request)) throw new Vi("operation-not-supported-in-this-environment", "fetch, Headers and Request native APIs or equivalent Polyfills must be available to support HTTP requests from a Worker environment."); var a = new _o(this.c); if (o) { a.g = Math.max(0, o); var s = setTimeout(function() { a.dispatchEvent("timeout") }, o) }
                        Oe(a, "complete", function() { s && clearTimeout(s); var e = null; try { e = JSON.parse(function(e) { try { return e.a ? e.a.responseText : "" } catch (t) { return Eo(e.b, "Can not get responseText: " + t.message), "" } }(this)) || null } catch (t) { e = null }
                            n && n(e) }), Pe(a, "ready", function() { s && clearTimeout(s), Mt(this) }), Pe(a, "timeout", function() { s && clearTimeout(s), Mt(this), n && n(null) }), Do(a, t, e, i, r) }; var va = pn("https://apis.google.com/js/client.js?onload=%{onload}"),
                    ...
                    oa.prototype.m = function(t, n, i, r, o) { var a = this;
                    ...
                    function _a(t) { if (!t.oobCode) throw new Vi("invalid-action-code") }(t = oa.prototype).rb = function(t, i) { var r = { idToken: t },
                        ...
                        Ua = { endpoint: "getOobConfirmationCode", T: ["requestType"], B: function(t) { if ("EMAIL_SIGNIN" != t.requestType) throw new Vi("internal-error");
                                ga(t) }, da: "email" },
                        ...
                        Ka = { endpoint: "getOobConfirmationCode", T: ["requestType"], B: function(t) { if ("PASSWORD_RESET" != t.requestType) throw new Vi("internal-error");
                                ga(t) }, da: "email" },
                        ...
                        ts = { endpoint: "verifyPhoneNumber", B: function(t) { if (!t.idToken) throw new Vi("internal-error");
                                wa(t) }, J: function(t) { if (t.temporaryProof) throw t.code = "credential-already-in-use", io(t);
                                ya(t) } },
                        es = { Xb: { USER_NOT_FOUND: "user-not-found" }, endpoint: "verifyPhoneNumber", B: wa, J: ya };

                    function ns(t, e, n) { if (! function(t, e) { if (!e || !e.length) return !0; if (!t) return !1; for (var n = 0; n < e.length; n++) { var i = t[e[n]]; if (null == i || "" === i) return !1 } return !0 }(n, e.T)) return It(new Vi("internal-error")); var i, r = e.Ib || "POST"; return wt(n).then(e.B).then(function() { return e.R && (n.returnSecureToken = !0),
                                function(t, e, i, r, o, n) { var a = Ge(t.g + e);
                                    We(a, "key", t.b), n && We(a, "cb", b().toString()); var s = "GET" == i; if (s)
                                        for (var u in r) r.hasOwnProperty(u) && We(a, u, r[u]); return new dt(function(e, n) { pa(t, a.toString(), function(t) { t ? t.error ? n(rs(t, o || {})) : e(t) : n(new Vi("network-request-failed")) }, i, s ? void 0 : xn(di(r)), t.a, t.h.get()) }) }(t, e.endpoint, r, n, e.Xb, e.ub || !1) }).then(function(t) { return i = t, e.Oa ? e.Oa(n, i) : i }).then(e.J).then(function() { if (!e.da) return i; if (!(e.da in i)) throw new Vi("internal-error"); return i[e.da] }) }

                    function is(t) { return rs({ error: { errors: [{ message: t }], code: 400, message: t } }) }

                    function rs(t, e) { var n = (t.error && t.error.errors && t.error.errors[0] || {}).reason || "",
                            i = { keyInvalid: "invalid-api-key", ipRefererBlocked: "app-not-authorized" }; if (n = i[n] ? new Vi(i[n]) : null) return n; for (var r in n = t.error && t.error.message || "", st(i = { INVALID_CUSTOM_TOKEN: "invalid-custom-token", CREDENTIAL_MISMATCH: "custom-token-mismatch", MISSING_CUSTOM_TOKEN: "internal-error", INVALID_IDENTIFIER: "invalid-email", MISSING_CONTINUE_URI: "internal-error", INVALID_EMAIL: "invalid-email", INVALID_PASSWORD: "wrong-password", USER_DISABLED: "user-disabled", MISSING_PASSWORD: "internal-error", EMAIL_EXISTS: "email-already-in-use", PASSWORD_LOGIN_DISABLED: "operation-not-allowed", INVALID_IDP_RESPONSE: "invalid-credential", INVALID_PENDING_TOKEN: "invalid-credential", FEDERATED_USER_ID_ALREADY_LINKED: "credential-already-in-use", MISSING_OR_INVALID_NONCE: "missing-or-invalid-nonce", INVALID_MESSAGE_PAYLOAD: "invalid-message-payload", INVALID_RECIPIENT_EMAIL: "invalid-recipient-email", INVALID_SENDER: "invalid-sender", EMAIL_NOT_FOUND: "user-not-found", RESET_PASSWORD_EXCEED_LIMIT: "too-many-requests", EXPIRED_OOB_CODE: "expired-action-code", INVALID_OOB_CODE: "invalid-action-code", MISSING_OOB_CODE: "internal-error", INVALID_PROVIDER_ID: "invalid-provider-id", CREDENTIAL_TOO_OLD_LOGIN_AGAIN: "requires-recent-login", INVALID_ID_TOKEN: "invalid-user-token", TOKEN_EXPIRED: "user-token-expired", USER_NOT_FOUND: "user-token-expired", CORS_UNSUPPORTED: "cors-unsupported", DYNAMIC_LINK_NOT_ACTIVATED: "dynamic-link-not-activated", INVALID_APP_ID: "invalid-app-id", TOO_MANY_ATTEMPTS_TRY_LATER: "too-many-requests", WEAK_PASSWORD: "weak-password", OPERATION_NOT_ALLOWED: "operation-not-allowed", USER_CANCELLED: "user-cancelled", CAPTCHA_CHECK_FAILED: "captcha-check-failed", INVALID_APP_CREDENTIAL: "invalid-app-credential", INVALID_CODE: "invalid-verification-code", INVALID_PHONE_NUMBER: "invalid-phone-number", INVALID_SESSION_INFO: "invalid-verification-id", INVALID_TEMPORARY_PROOF: "invalid-credential", MISSING_APP_CREDENTIAL: "missing-app-credential", MISSING_CODE: "missing-verification-code", MISSING_PHONE_NUMBER: "missing-phone-number", MISSING_SESSION_INFO: "missing-verification-id", QUOTA_EXCEEDED: "quota-exceeded", SESSION_EXPIRED: "code-expired", REJECTED_CREDENTIAL: "rejected-credential", INVALID_CONTINUE_URI: "invalid-continue-uri", MISSING_ANDROID_PACKAGE_NAME: "missing-android-pkg-name", MISSING_IOS_BUNDLE_ID: "missing-ios-bundle-id", UNAUTHORIZED_DOMAIN: "unauthorized-continue-uri", INVALID_DYNAMIC_LINK_DOMAIN: "invalid-dynamic-link-domain", INVALID_OAUTH_CLIENT_ID: "invalid-oauth-client-id", INVALID_CERT_HASH: "invalid-cert-hash" }, e || {}), e = (e = n.match(/^[^\s]+\s*:\s*(.*)$/)) && 1 < e.length ? e[1] : void 0, i)
                    ...
                    function os(t) { var o;
                        this.b = t, this.a = null, this.fb = (o = this, (cs || (cs = new dt(function(t, e) {
                            function n() { gi(), ai("gapi.load")("gapi.iframes", { callback: t, ontimeout: function() { gi(), e(Error("Network Error")) }, timeout: ss.get() }) } if (ai("gapi.iframes.Iframe")) t();
                            else if (ai("gapi.load")) n();
                            else { var i = "__iframefcb" + Math.floor(1e6 * Math.random()).toString();
                                h[i] = function() { ai("gapi.load") ? n() : e(Error("Network Error")) }, wt(Zo(i = gn(as, { onload: i }))).s(function() { e(Error("Network Error")) }) } }).s(function(t) { throw cs = null, t }))).then(function() { return new dt(function(i, r) { ai("gapi.iframes.getContext")().open({ where: document.body, url: o.b, messageHandlersFilter: ai("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"), attributes: { style: { position: "absolute", top: "-100px", width: "1px", height: "1px" } }, dontclear: !0 }, function(t) {
                                    function e() { clearTimeout(n), i() }
                                    o.a = t, o.a.restyle({ setHideOnLeave: !1 }); var n = setTimeout(function() { r(Error("Network Error")) }, us.get());
                                    t.ping(e).then(e, function() { r(Error("Network Error")) }) }) }) })) } var as = pn("https://apis.google.com/js/api.js?onload=%{onload}"),
                        ss = new bi(3e4, 6e4),
                        us = new bi(5e3, 15e3),
                        cs = null;
                    ...
                    function ps(t) { var e, s = Fn(); return (e = t, ns(e, Fa, {}).then(function(t) { return t.authorizedDomains || [] })).then(function(t) { t: { var e = Ge(s),
                                    n = e.c;e = e.b; for (var i = 0; i < t.length; i++) { var r = t[i],
                                        o = e,
                                        a = n; if (o = 0 == r.indexOf("chrome-extension://") ? Ge(r).b == o && "chrome-extension" == a : ("http" == a || "https" == a) && (Gn.test(r) ? o == r : (r = r.split(".").join("\\."), new RegExp("^(.+\\." + r + "|" + r + ")$", "i").test(o)))) { t = !0; break t } }
                                t = !1 } if (!t) throw new eo(Fn()) }) }

                    function vs(r) { return r.l || (r.l = Jn().then(function() { if (!r.u) { var t = r.c,
                                    e = r.h,
                                    n = fs(r.b),
                                    i = new hs(r.m, r.f, r.b);
                                i.f = t, i.b = e, i.c = U(n || []), r.u = i.toString() }
                            r.i = new os(r.u),
                                function(i) { if (!i.i) throw Error("IfcHandler must be initialized!");
                                    t = i.i, e = function(t) { var e = {}; if (t && t.authEvent) { var n = !1; for (t = $r(t.authEvent), e = 0; e < i.g.length; e++) n = i.g[e](t) || n; return (e = {}).status = n ? "ACK" : "ERROR", wt(e) } return e.status = "ERROR", wt(e) }, t.fb.then(function() { t.a.register("authEvent", e, ai("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER")) }); var t, e }(r) })), r.l }
                    ...
                    function bs(t) { if (this.a = t || Lh.INTERNAL.reactNative && Lh.INTERNAL.reactNative.AsyncStorage, !this.a) throw new Vi("internal-error", "The React Native compatibility library was not found.");
                        this.type = "asyncStorage" }

                    function ys(t) { this.b = t, this.a = {}, this.c = m(this.f, this) }
                    hs.prototype.toString = function() { return this.f ? We(this.a, "v", this.f) : an(this.a.a, "v"), this.b ? We(this.a, "eid", this.b) : an(this.a.a, "eid"), this.c.length ? We(this.a, "fw", this.c.join(",")) : an(this.a.a, "fw"), this.a.toString() }, ls.prototype.toString = function() { var t = Xe(this.o, "/__/auth/handler"); if (We(t, "apiKey", this.m), We(t, "appName", this.c), We(t, "authType", this.l), this.a.isOAuthProvider) { var e = this.a; try { var n = Lh.app(this.c).auth().ea() } catch (t) { n = null } for (var i in e.$a = n, We(t, "providerId", this.a.providerId), n = di((e = this.a).yb)) n[i] = n[i].toString();
                            i = e.Dc, n = it(n); for (var r = 0; r < i.length; r++) { var o = i[r];
                                o in n && delete n[o] }
                            e.cb && e.$a && !n[e.cb] && (n[e.cb] = e.$a), nt(n) || We(t, "customParameters", fi(n)) } if ("function" == typeof this.a.Eb && ((e = this.a.Eb()).length && We(t, "scopes", e.join(","))), this.i ? We(t, "redirectUrl", this.i) : an(t.a, "redirectUrl"), this.g ? We(t, "eventId", this.g) : an(t.a, "eventId"), this.h ? We(t, "v", this.h) : an(t.a, "v"), this.b)
                            for (var a in this.b) this.b.hasOwnProperty(a) && !Be(t, a) && We(t, a, this.b[a]); return this.f ? We(t, "eid", this.f) : an(t.a, "eid"), (a = fs(this.c)).length && We(t, "fw", a.join(",")), t.toString() }, (t = ds.prototype).Ea = function(e, n, t) { var i = new Vi("popup-closed-by-user"),
                            r = new Vi("web-storage-unsupported"),
                            o = this,
                            a = !1; return this.ga().then(function() { var t, i;
                            (t = o, i = { type: "webStorageSupport" }, vs(t).then(function() { return e = t.i, n = i, e.fb.then(function() { return new dt(function(t) { e.a.send(n.type, n, t, ai("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER")) }) }); var e, n }).then(function(t) { if (t && t.length && void 0 !== t[0].webStorageSupport) return t[0].webStorageSupport; throw Error() })).then(function(t) { t || (e && Wn(e), n(r), a = !0) }) }).s(function() {}).then(function() { if (!a) return n = e, new dt(function(e) { return function t() { Ce(2e3).then(function() { if (n && !n.closed) return t();
                                        e() }) }() }); var n }).then(function() { if (!a) return Ce(t).then(function() { n(i) }) }) }, t.Mb = function() { var t = oi(); return !li(t) && !mi(t) }, t.Hb = function() { return !1 }, t.Cb = function(e, t, n, i, r, o, a) { if (!e) return It(new Vi("popup-blocked")); if (a && !li()) return this.ga().s(function(t) { Wn(e), r(t) }), i(), wt();
                        this.a || (this.a = ps(ms(this))); var s = this; return this.a.then(function() { var t = s.ga().s(function(t) { throw Wn(e), r(t), t }); return i(), t }).then(function() {
                            (zr(n), a) || qn(gs(s.m, s.f, s.b, t, n, null, o, s.c, void 0, s.h), e) }).s(function(t) { throw "auth/network-request-failed" == t.code && (s.a = null), t }) }, t.Ca = function(t, e, n) { this.a || (this.a = ps(ms(this))); var i = this; return this.a.then(function() { zr(e), qn(gs(i.m, i.f, i.b, t, e, Fn(), n, i.c, void 0, i.h)) }).s(function(t) { throw "auth/network-request-failed" == t.code && (i.a = null), t }) }, t.ga = function() { var t = this; return vs(this).then(function() { return t.i.fb }).s(function() { throw t.a = null, new Vi("network-request-failed") }) }, t.Qb = function() { return !0 }, t.wa = function(t) { this.g.push(t) }, t.Ka = function(e) { M(this.g, function(t) { return t == e }) }, (t = bs.prototype).get = function(t) { return wt(this.a.getItem(t)).then(function(t) { return t && pi(t) }) }, t.set = function(t, e) { return wt(this.a.setItem(t, fi(e))) }, t.P = function(t) { return wt(this.a.removeItem(t)) }, t.Y = function() {}, t.ca = function() {}; var ws, Is = [];

                    function Ts(t) { this.a = t }

                    function Es(t) { this.c = t, this.b = !1, this.a = [] }

                    function As(i, t, e, n) { var r, o, a, s, u = e || {},
                            c = null; if (i.b) return It(Error("connection_unavailable")); var h = n ? 800 : 50,
                    ...
                    function ks(t, e) { if (e) { var n = e.messageChannel,
                                i = e.onMessage;
                            n && (n.port1.removeEventListener("message", i), n.port1.close()), M(t.a, function(t) { return t == e }) } }

                    function Ss() { if (!Os()) throw new Vi("web-storage-unsupported");
                        this.c = {}, this.a = [], this.b = 0, this.m = h.indexedDB, this.type = "indexedDB", this.g = this.l = this.f = this.i = null, this.u = !1, this.h = null; var t, i = this;
                        $n() && self ? (this.l = function() { var e = $n() ? self : null; if (R(Is, function(t) { t.b == e && (n = t) }), !n) { var n = new ys(e);
                    ...
                    function Ns(r) { return new dt(function(e, n) { var t = r.m.open("firebaseLocalStorageDb", 1);
                            t.onerror = function(t) { try { t.preventDefault() } catch (t) {}
                                ...
                                (t = t.target.result).objectStoreNames.contains("firebaseLocalStorage") ? e(t) : (i = r, new dt(function(t, e) { var n = i.m.deleteDatabase("firebaseLocalStorageDb");
                                    n.onsuccess = function() { t() }, n.onerror = function(t) { e(Error(t.target.error)) } })).then(function() { return Ns(r) }).then(function(t) { e(t) }).s(function(t) { n(t) }) } }) }
                    ...
                    function Ls(i) { return _s(i).then(function(t) { var r = Ps(Rs(t, !1)); return r.getAll ? Ds(r.getAll()) : new dt(function(e, n) { var i = [],
                                    t = r.openCursor();
                                ...
                                n = function t(e, n) { var i, r = []; for (i in e) i in n ? typeof e[i] != typeof n[i] ? r.push(i) : "object" == typeof e[i] && null != e[i] && null != n[i] ? 0 < t(e[i], n[i]).length && r.push(i) : e[i] !== n[i] && r.push(i) : r.push(i); for (i in n) i in e || r.push(i); return r }(i.c, e), i.c = e } return n }) }

                    function xs(t) { t.i && t.i.cancel("STOP_EVENT"), t.f && (clearTimeout(t.f), t.f = null) }

                    function Ms(t) { var i = this,
                            r = null;
                        this.a = [], this.type = "indexedDB", this.c = t, this.b = wt().then(function() { if (Os()) { var e = vi(),
                                    n = "__sak" + e; return ws || (ws = new Ss), (r = ws).set(n, e).then(function() { return r.get(n) }).then(function(t) { if (t !== e) throw Error("indexedDB not supported!"); return r.P(n) }).then(function() { return r }).s(function() { return i.c }) } return i.c }).then(function(t) { return i.type = t.type, t.Y(function(e) { R(i.a, function(t) { t(e) }) }), t }) }

                    function js() { this.a = {}, this.type = "inMemory" }

                    function Us() { if (! function() { var t = "Node" == Zn(); if (!(t = Vs() || t && Lh.INTERNAL.node && Lh.INTERNAL.node.localStorage)) return !1; try { return t.setItem("__sak", "1"), t.removeItem("__sak"), !0 } catch (t) { return !1 } }()) { if ("Node" == Zn()) throw new Vi("internal-error", "The LocalStorage compatibility library was not found."); throw new Vi("web-storage-unsupported") }
                        this.a = Vs() || Lh.INTERNAL.node.localStorage, this.type = "localStorage" }

                    function Vs() { try { var t = h.localStorage,
                                e = vi(); return t && (t.setItem(e, "1"), t.removeItem(e)), t } catch (t) { return null } }

                    function Ks() { this.type = "nullStorage" }

                    function Fs() { if (! function() { var t = "Node" == Zn(); if (!(t = qs() || t && Lh.INTERNAL.node && Lh.INTERNAL.node.sessionStorage)) return !1; try { return t.setItem("__sak", "1"), t.removeItem("__sak"), !0 } catch (t) { return !1 } }()) { if ("Node" == Zn()) throw new Vi("internal-error", "The SessionStorage compatibility library was not found."); throw new Vi("web-storage-unsupported") }
                        this.a = qs() || Lh.INTERNAL.node.sessionStorage, this.type = "sessionStorage" }

                    function qs() { try { var t = h.sessionStorage,
                                e = vi(); return t && (t.setItem(e, "1"), t.removeItem(e)), t } catch (t) { return null } }

                    function Hs() { var t = {};
                        t.Browser = Gs, t.Node = Xs, t.ReactNative = Js, t.Worker = zs, this.a = t[Zn()] }
                    ys.prototype.f = function(n) { var i = n.data.eventType,
                            r = n.data.eventId,
                            t = this.a[i]; if (t && 0 < t.length) { n.ports[0].postMessage({ status: "ack", eventId: r, eventType: i, response: null }); var e = [];
                            R(t, function(t) { e.push(wt().then(function() { return t(n.origin, n.data.data) })) }), Et(e).then(function(t) { var e = [];
                                R(t, function(t) { e.push({ fulfilled: t.Db, value: t.value, reason: t.reason ? t.reason.message : void 0 }) }), R(e, function(t) { for (var e in t) void 0 === t[e] && delete t[e] }), n.ports[0].postMessage({ status: "done", eventId: r, eventType: i, response: e }) }) } }, ys.prototype.subscribe = function(t, e) { nt(this.a) && this.b.addEventListener("message", this.c), void 0 === this.a[t] && (this.a[t] = []), this.a[t].push(e) }, ys.prototype.unsubscribe = function(t, e) { void 0 !== this.a[t] && e ? (M(this.a[t], function(t) { return t == e }), 0 == this.a[t].length && delete this.a[t]) : e || delete this.a[t], nt(this.a) && this.b.removeEventListener("message", this.c) }, Ts.prototype.postMessage = function(t, e) { this.a.postMessage(t, e) }, Es.prototype.close = function() { for (; 0 < this.a.length;) ks(this, this.a[0]);
                        this.b = !0 }, (t = Ss.prototype).set = function(n, i) { var r, o = !1,
                            a = this; return _s(this).then(function(t) { return Ds((t = Ps(Rs(r = t, !0))).get(n)) }).then(function(t) { var e = Ps(Rs(r, !0)); return t ? (t.value = i, Ds(e.put(t))) : (a.b++, o = !0, (t = {}).fbase_key = n, t.value = i, Ds(e.add(t))) }).then(function() { return a.c[n] = i, Cs(a, n) }).ia(function() { o && a.b-- }) }, t.get = function(e) { return _s(this).then(function(t) { return Ds(Ps(Rs(t, !1)).get(e)) }).then(function(t) { return t && t.value }) }, t.P = function(e) { var n = !1,
                            i = this; return _s(this).then(function(t) { return n = !0, i.b++, Ds(Ps(Rs(t, !0)).delete(e)) }).then(function() { return delete i.c[e], Cs(i, e) }).ia(function() { n && i.b-- }) }, t.Y = function(t) { var n;
                        0 == this.a.length && (xs(n = this), function e() { n.f = setTimeout(function() { n.i = Ls(n).then(function(e) { 0 < e.length && R(n.a, function(t) { t(e) }) }).then(function() { e() }).s(function(t) { "STOP_EVENT" != t.message && e() }) }, 800) }()), this.a.push(t) }, t.ca = function(e) { M(this.a, function(t) { return t == e }), 0 == this.a.length && xs(this) }, (t = Ms.prototype).get = function(e) { return this.b.then(function(t) { return t.get(e) }) }, t.set = function(e, n) { return this.b.then(function(t) { return t.set(e, n) }) }, t.P = function(e) { return this.b.then(function(t) { return t.P(e) }) }, t.Y = function(t) { this.a.push(t) }, t.ca = function(e) { M(this.a, function(t) { return t == e }) }, (t = js.prototype).get = function(t) { return wt(this.a[t]) }, t.set = function(t, e) { return this.a[t] = e, wt() }, t.P = function(t) { return delete this.a[t], wt() }, t.Y = function() {}, t.ca = function() {}, (t = Us.prototype).get = function(t) { var e = this; return wt().then(function() { return pi(e.a.getItem(t)) }) }, t.set = function(e, n) { var i = this; return wt().then(function() { var t = fi(n);
                            null === t ? i.P(e) : i.a.setItem(e, t) }) }, t.P = function(t) { var e = this; return wt().then(function() { e.a.removeItem(t) }) }, t.Y = function(t) { h.window && me(h.window, "storage", t) }, t.ca = function(t) { h.window && ye(h.window, "storage", t) }, (t = Ks.prototype).get = function() { return wt(null) }, t.set = function() { return wt() }, t.P = function() { return wt() }, t.Y = function() {}, t.ca = function() {}, (t = Fs.prototype).get = function(t) { var e = this; return wt().then(function() { return pi(e.a.getItem(t)) }) }, t.set = function(e, n) { var i = this; return wt().then(function() { var t = fi(n);
                            null === t ? i.P(e) : i.a.setItem(e, t) }) }, t.P = function(t) { var e = this; return wt().then(function() { e.a.removeItem(t) }) }, t.Y = function() {}, t.ca = function() {}; var Ws, Bs, Gs = { A: Us, Ra: Fs },
                        Xs = { A: Us, Ra: Fs },
                        Js = { A: bs, Ra: Ks },
                        zs = { A: Us, Ra: Ks },
                        Ys = { Zc: "local", NONE: "none", ad: "session" };

                    function $s() { var t = !(mi(oi()) || !Yn()),
                            e = li(),
                            n = si();
                        this.o = t, this.h = e, this.l = n, this.a = {}, Ws || (Ws = new Hs), t = Ws; try { this.g = !Kn() && Ii() || !h.indexedDB ? new t.a.A : new Ms($n() ? new js : new t.a.A) } catch (t) { this.g = new js, this.h = !0 } try { this.i = new t.a.Ra } catch (t) { this.i = new js }
                        this.m = new js, this.f = m(this.Pb, this), this.b = {} }

                    function Zs() { return Bs || (Bs = new $s), Bs }

                    function Qs(t, e) { switch (e) {
                            case "session":
                                return t.i;
                            case "none":
                                return t.m;
                    ...
                    function iu(t) { this.a = t, this.b = Zs() }(t = $s.prototype).get = function(t, e) { return Qs(this, t.A).get(tu(t, e)) }, t.set = function(e, t, n) { var i = tu(e, n),
                            r = this,
                            o = Qs(this, e.A); return o.set(i, t).then(function() { return o.get(i) }).then(function(t) { "local" == e.A && (r.b[i] = t) }) }, t.addListener = function(t, e, n) { var i;
                        t = tu(t, e), this.l && (this.b[t] = h.localStorage.getItem(t)), nt(this.a) && (Qs(this, "local").Y(this.f), this.h || (Kn() || !Ii()) && h.indexedDB || !this.l || (nu(i = this), i.c = setInterval(function() { for (var t in i.a) { var e = h.localStorage.getItem(t),
                                    n = i.b[t];
                                e != n && (i.b[t] = e, e = new oe({ type: "storage", key: t, target: window, oldValue: n, newValue: e, a: !0 }), i.Pb(e)) } }, 1e3))), this.a[t] || (this.a[t] = []), this.a[t].push(n) }, t.removeListener = function(t, e, n) { t = tu(t, e), this.a[t] && (M(this.a[t], function(t) { return t == n }), 0 == this.a[t].length && delete this.a[t]), nt(this.a) && (Qs(this, "local").ca(this.f), nu(this)) }, t.Pb = function(t) { if (t && t.f) { var e = t.a.key; if (null == e)
                                for (var n in this.a) { var i = this.b[n];
                                    void 0 === i && (i = null); var r = h.localStorage.getItem(n);
                                    r !== i && (this.b[n] = r, this.Xa(n)) } else if (0 == e.indexOf("firebase:") && this.a[e]) { if (void 0 !== t.a.a ? Qs(this, "local").ca(this.f) : nu(this), this.o)
                                    ...
                                    n = function() { void 0 === t.a.a && o.b[e] === h.localStorage.getItem(e) || (o.b[e] = h.localStorage.getItem(e), o.Xa(e)) }, Ft && Yt && 10 == Yt && h.localStorage.getItem(e) !== t.a.newValue && t.a.newValue !== t.a.oldValue ? setTimeout(n, 10) : n() } } else R(t, m(this.Xa, this)) }, t.Xa = function(t) { this.a[t] && R(this.a[t], function(t) { t() }) }; var ru, ou = { name: "authEvent", A: "local" };
                    ...
                    y(su, function() { this.b = -1 }); for (var uu = 64, cu = uu - 1, hu = [], lu = 0; lu < cu; lu++) hu[lu] = 0; var fu = j(128, hu);

                    function du(t) { for (var e = t.f, n = t.l, i = 0, r = 0; r < e.length;) n[i++] = e[r] << 24 | e[r + 1] << 16 | e[r + 2] << 8 | e[r + 3], r = 4 * i; for (e = 16; e < 64; e++) { r = 0 | n[e - 15], i = 0 | n[e - 2]; var o = (0 | n[e - 16]) + ((r >>> 7 | r << 25) ^ (r >>> 18 | r << 14) ^ r >>> 3) | 0,
                    ...
                    function pu(t, e, n) { void 0 === n && (n = e.length); var i = 0,
                            r = t.c; if (c(e))
                    ...
                    y(mu, su); var gu = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225];
                    ...
                    function wu(t) { var e = new mu;
                        pu(e, t), t = []; var n = 8 * e.g;
                        e.c < 56 ? pu(e, fu, 56 - e.c) : pu(e, fu, e.b - (e.c - 56)); for (var i = 63; 56 <= i; i--) e.f[i] = 255 & n, n /= 256; for (du(e), i = n = 0; i < e.i; i++)
                            for (var r = 24; 0 <= r; r -= 8) t[n++] = e.a[i] >> r & 255; return D(t, function(t) { return 1 < (t = t.toString(16)).length ? t : "0" + t }).join("") }

                    function Iu(t, e) { for (var n = 0; n < t.b.length; n++) try { t.b[n](e) } catch (t) {} }

                    function Tu(i) { return i.f || (i.f = i.ga().then(function() { return new dt(function(n) { i.wa(function t(e) { return n(e), i.Ka(t), !1 }),
                                    function(r) {
                                        function e(i) { t = !0, n && n.cancel(), Eu(r).then(function(t) { var e = o; if (t && i && i.url) { var n = null; - 1 != (e = Er(i.url)).indexOf("/__/auth/callback") && (n = (n = "object" == typeof(n = pi(Be(n = Ge(e), "firebaseError") || null)) ? Ki(n) : null) ? new Yr(t.b, t.c, null, null, n) : new Yr(t.b, t.c, e, t.g)), e = n || o }
                                                Iu(r, e) }) } var o = new Yr("unknown", null, null, null, new Vi("no-auth-event")),
                                            t = !1,
                                            n = Ce(500).then(function() { return Eu(r).then(function() { t || Iu(r, o) }) }),
                                            i = h.handleOpenURL;
                                        h.handleOpenURL = function(t) { if (0 == t.toLowerCase().indexOf(ai("BuildInfo.packageName", h).toLowerCase() + "://") && e({ url: t }), "function" == typeof i) try { i(t) } catch (t) { console.error(t) } }, to || (to = new Zr), to.subscribe(e) }(i) }) })), i.f }
                    ...
                    function Au(t) { this.a = t, this.b = Zs() }(t = bu.prototype).ga = function() { return this.za ? this.za : this.za = (zn(void 0) ? Jn().then(function() { return new dt(function(t, e) { var n = h.document,
                                    i = setTimeout(function() { e(Error("Cordova framework is not ready.")) }, 1e3);
                                n.addEventListener("deviceready", function() { clearTimeout(i), t() }, !1) }) }) : It(Error("Cordova must run in an Android or iOS file scheme."))).then(function() { if ("function" != typeof ai("universalLinks.subscribe", h)) throw yu("cordova-universal-links-plugin-fix is not installed"); if (void 0 === ai("BuildInfo.packageName", h)) throw yu("cordova-plugin-buildinfo is not installed"); if ("function" != typeof ai("cordova.plugins.browsertab.openUrl", h)) throw yu("cordova-plugin-browsertab is not installed"); if ("function" != typeof ai("cordova.InAppBrowser.open", h)) throw yu("cordova-plugin-inappbrowser is not installed") }, function() { throw new Vi("cordova-not-ready") }) }, t.Ea = function(t, e) { return e(new Vi("operation-not-supported-in-this-environment")), wt() }, t.Cb = function() { return It(new Vi("operation-not-supported-in-this-environment")) }, t.Qb = function() { return !1 }, t.Mb = function() { return !0 }, t.Hb = function() { return !0 }, t.Ca = function(t, e, n) { if (this.c) return It(new Vi("redirect-operation-pending")); var i = this,
                            r = h.document,
                            o = null,
                            a = null,
                            s = null,
                            u = null; return this.c = wt().then(function() { return zr(e), Tu(i) }).then(function() { return function(n, t, e, i) { var r = function() { for (var t = 20, e = []; 0 < t;) e.push("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(Math.floor(62 * Math.random()))), t--; return e.join("") }(),
                                    o = new Yr(t, i, null, r, new Vi("no-auth-event")),
                                    a = ai("BuildInfo.packageName", h); if ("string" != typeof a) throw new Vi("invalid-cordova-configuration"); var s = ai("BuildInfo.displayName", h),
                                    u = {}; if (oi().toLowerCase().match(/iphone|ipad|ipod/)) u.ibi = a;
                                else { if (!oi().toLowerCase().match(/android/)) return It(new Vi("operation-not-supported-in-this-environment"));
                                    u.apn = a }
                                s && (u.appDisplayName = s), r = wu(r), u.sessionId = r; var c = gs(n.m, n.i, n.l, t, e, null, i, n.o, u, n.u); return n.ga().then(function() { var t = n.h; return n.v.a.set(ou, o.C(), t) }).then(function() { var t = ai("cordova.plugins.browsertab.isAvailable", h); if ("function" != typeof t) throw new Vi("invalid-cordova-configuration"); var e = null;
                                    t(function(t) { if (t) { if ("function" != typeof(e = ai("cordova.plugins.browsertab.openUrl", h))) throw new Vi("invalid-cordova-configuration");
                                            e(c) } else { if ("function" != typeof(e = ai("cordova.InAppBrowser.open", h))) throw new Vi("invalid-cordova-configuration");
                                            t = !(!(t = oi()).match(/(iPad|iPhone|iPod).*OS 7_\d/i) && !t.match(/(iPad|iPhone|iPod).*OS 8_\d/i)), n.a = e(c, t ? "_blank" : "_system", "location=yes") } }) }) }(i, t, e, n) }).then(function() { return new dt(function(e, t) { a = function() { var t = ai("cordova.plugins.browsertab.close", h); return e(), "function" == typeof t && t(), i.a && "function" == typeof i.a.close && (i.a.close(), i.a = null), !1 }, i.wa(a), s = function() { o || (o = Ce(2e3).then(function() { t(new Vi("redirect-cancelled-by-user")) })) }, u = function() { yi() && s() }, r.addEventListener("resume", s, !1), oi().toLowerCase().match(/android/) || r.addEventListener("visibilitychange", u, !1) }).s(function(t) { return Eu(i).then(function() { throw t }) }) }).ia(function() { s && r.removeEventListener("resume", s, !1), u && r.removeEventListener("visibilitychange", u, !1), o && o.cancel(), a && i.Ka(a), i.c = null }) }, t.wa = function(e) { this.b.push(e), Tu(this).s(function(t) { "auth/invalid-cordova-configuration" === t.code && (t = new Yr("unknown", null, null, null, new Vi("no-auth-event")), e(t)) }) }, t.Ka = function(e) { M(this.b, function(t) { return t == e }) }; var ku = { name: "pendingRedirect", A: "session" };
                    ...
                    function Pu(n) { n.a.Mb() && Ou(n).s(function(t) { var e = new Yr("unknown", null, null, null, new Vi("operation-not-supported-in-this-environment"));
                            Lu(t) && n.bb(e) }), n.a.Hb() || Uu(n.b) }(t = Nu.prototype).reset = function() { this.f = !1, this.a.Ka(this.i), this.a = _u(this.u, this.l, this.m) }, t.Ya = function() { this.b.Ya() }, t.subscribe = function(t) { if (L(this.h, t) || this.h.push(t), !this.f) { var n = this;
                            (e = this.g, e.b.get(ku, e.a).then(function(t) { return "pending" == t })).then(function(t) { t ? Su(n.g).then(function() { Ou(n).s(function(t) { var e = new Yr("unknown", null, null, null, new Vi("operation-not-supported-in-this-environment"));
                                        Lu(t) && n.bb(e) }) }) : Pu(n) }).s(function() { Pu(n) }) } var e }, t.unsubscribe = function(e) { M(this.h, function(t) { return t == e }) }, t.bb = function(t) { if (!t) throw new Vi("invalid-auth-event"); for (var e = !1, n = 0; n < this.h.length; n++) { var i = this.h[n]; if (i.vb(t.b, t.c)) {
                                (e = this.c[t.b]) && e.h(t, i), e = !0; break } } return Uu(this.b), e }; var Ru = new bi(2e3, 1e4),
                        Du = new bi(3e4, 6e4);
                    ...
                    function Vu(t, e) { if (t.b = function() { return wt(e) }, t.f.length)
                            for (var n = 0; n < t.f.length; n++) t.f[n](e) }

                    function Ku(t, e, n, i) { e ? i ? function(t, e) { if (t.b = function() { return It(e) }, t.c.length)
                                for (var n = 0; n < t.c.length; n++) t.c[n](e) }(t, i) : Vu(t, n) : Vu(t, { user: null }), t.f = [], t.c = [] }
                    ...
                    function Bu(t) { var e = or(t); if (!(e && e.exp && e.auth_time && e.iat)) throw new Vi("internal-error", "An internal error occurred. The token obtained by Firebase appears to be malformed. Please retry the operation.");
                    ...
                    function Ac(n, i, t, e, r) { if (!ui()) return It(new Vi("operation-not-supported-in-this-environment")); if (n.i && !r) return It(n.i); var o = fr(t.providerId),
                            a = vi(n.uid + ":::"),
                            s = null;
                        (!li() || Yn()) && n.u && t.isOAuthProvider && (s = gs(n.u, n.m, n.o, i, t, null, a, Lh.SDK_VERSION || null)); var u = Bn(s, o && o.Ba, o && o.Aa); return e = e().then(function() { if (Sc(n), !r) return n.F().then(function() {}) }).then(function() { return Cu(n.a, u, i, t, a, !!s) }).then(function() { return new dt(function(t, e) { n.ha(i, null, new Vi("cancelled-popup-request"), n.g || null), n.f = t, n.v = e, n.g = a, n.c = n.a.Ea(n, i, u, a) }) }).then(function(t) { return u && Wn(u), t ? _i(t) : null }).s(function(t) { throw u && Wn(u), t }), Nc(n, e, r) }

                    function kc(e, t, n, i, r) { if (!ui()) return It(new Vi("operation-not-supported-in-this-environment")); if (e.i && !r) return It(e.i); var o = null,
                            a = vi(e.uid + ":::"); return i = i().then(function() { if (Sc(e), !r) return e.F().then(function() {}) }).then(function() { return e.aa = a, cc(e) }).then(function(t) { return e.ba && (t = (t = e.ba).b.set(Pc, e.C(), t.a)), t }).then(function() { return e.a.Ca(t, n, a) }).s(function(t) { if (o = t, e.ba) return Rc(e.ba); throw o }).then(function() { if (o) throw o }), Nc(e, i, r) }
                    ...
                    function Kc(t) { if (this.m = !1, Si(this, "settings", new qu), Si(this, "app", t), !Xc(this).options || !Xc(this).options.apiKey) throw new Vi("invalid-api-key"); var n, e, i, r, o, a, s, u, c, h, l, f;
                        t = Lh.SDK_VERSION ? ri(Lh.SDK_VERSION) : null, this.b = new oa(Xc(this).options && Xc(this).options.apiKey, ur(ar), t), this.N = [], this.o = [], this.I = [], this.Tb = Lh.INTERNAL.createSubscribe(m(this.mc, this)), this.O = void 0, this.Ub = Lh.INTERNAL.createSubscribe(m(this.nc, this)), Bc(this, null), this.h = new Dc(Xc(this).options.apiKey + ":" + Xc(this).name), this.w = new Oc(Xc(this).options.apiKey + ":" + Xc(this).name), this.V = $c(this, (e = Xc(n = this).options.authDomain, i = (r = n, o = (a = r.w, s = Xc(r).options.authDomain, a.b.get(Pc, a.a).then(function(t) { return t && s && (t.authDomain = s), _c(t || {}) })).then(function(t) { return (r.D = t) && (t.ba = r.w), Rc(r.w) }), $c(r, o)).then(function() { return Uc(n.h, e) }).then(function(e) { return e ? (e.ba = n.w, n.D && (n.D.aa || null) == (e.aa || null) ? e : e.reload().then(function() { return Mc(n.h, e).then(function() { return e }) }).s(function(t) { return "auth/network-request-failed" == t.code ? e : jc(n.h) })) : null }).then(function(t) { Bc(n, t || null) }), $c(n, i))), this.i = $c(this, (u = this).V.then(function() { return u.fa() }).s(function() {}).then(function() { if (!u.m) return u.ka() }).s(function() {}).then(function() { if (!u.m) { u.X = !0; var t = u.h;
                                t.b.addListener(xc("local"), t.a, u.ka) } })), this.X = !1, this.ka = m(this.Mc, this), this.Ha = m(this.Z, this), this.ra = m(this.bc, this), this.sa = m(this.jc, this), this.ta = m(this.kc, this), h = Xc(c = this).options.authDomain, l = Xc(c).options.apiKey, h && ui() && (c.Sb = c.V.then(function() { if (!c.m) { if (c.a = Mu(h, l, Xc(c).name), c.a.subscribe(c), Jc(c) && hc(Jc(c)), c.D) { hc(c.D); var t = c.D;
                                    t.pa(c.ea()), nc(t, c), ic(t = c.D, c.G), rc(t, c), c.D = null } return c.a } })), this.INTERNAL = {}, this.INTERNAL.delete = m(this.delete, this), this.INTERNAL.logFramework = m(this.tc, this), this.u = 0, _e.call(this), f = this, Object.defineProperty(f, "lc", { get: function() { return this.ea() }, set: function(t) { this.pa(t) }, enumerable: !1 }), f.W = null, this.G = [] }
                    ...
                    function Gc(e, t) { var n = null,
                            i = null; return $c(e, t.then(function(t) { return n = Jr(t), i = dr(t), Wc(e, t) }).then(function() { return _i({ user: Jc(e), credential: n, additionalUserInfo: i, operationType: "signIn" }) })) }
                    ...
                    function Yc(t) { if (t.X) { for (var e = 0; e < t.o.length; e++) t.o[e] && t.o[e](zc(t)); if (t.O !== t.getUid() && t.I.length)
                    ...
                    Dc.prototype.mb = function(e) { var n = null,
                            i = this; return function(t) { var e = new Vi("invalid-persistence-type"),
                            ...
                            if (!i || "string" != typeof t) throw e; switch (Zn()) {
                                ...
                                default:
                                    if (!si() && "none" !== t) throw n } }(e), Vc(this, function() { return e != i.c.A ? i.b.get(i.c, i.a).then(function(t) { return n = t, Cc(i, e) }).then(function() { if (i.c = xc(e), n) return i.b.set(i.c, n, i.a) }) : wt() }) }, y(Kc, _e), y(Fc, re), y(qc, re), (t = Kc.prototype).mb = function(t) { return $c(this, t = this.h.mb(t)) }, t.pa = function(t) { this.W === t || this.m || (this.W = t, fa(this.b, this.W), this.dispatchEvent(new Fc(this.ea()))) }, t.ea = function() { return this.W }, t.Sc = function() { var t = h.navigator;
                        this.pa(t && (t.languages && t.languages[0] || t.language || t.userLanguage) || null) }, t.tc = function(t) { this.G.push(t), da(this.b, Lh.SDK_VERSION ? ri(Lh.SDK_VERSION, this.G) : null), this.dispatchEvent(new qc(this.G)) }, t.ya = function() { return U(this.G) }, t.toJSON = function() { return { apiKey: Xc(this).options.apiKey, authDomain: Xc(this).options.authDomain, appName: Xc(this).name, currentUser: Jc(this) && Jc(this).C() } }, t.vb = function(t, e) { switch (t) {
                            case "unknown":
                    ...
                    function oh() {}
                    Qc.prototype.render = function(t, e) { return this.a[this.b.toString()] = new ih(t, e), this.b++ }, Qc.prototype.reset = function(t) { var e = eh(this, t);
                        t = nh(t), e && t && (e.delete(), delete this.a[t]) }, Qc.prototype.getResponse = function(t) { return (t = eh(this, t)) ? t.getResponse() : null }, Qc.prototype.execute = function(t) {
                        (t = eh(this, t)) && t.execute() }, ih.prototype.getResponse = function() { return rh(this), this.b }, ih.prototype.execute = function() { rh(this); var n = this;
                        this.a || (this.a = setTimeout(function() { n.b = function() { for (var t = 50, e = []; 0 < t;) e.push("1234567890abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ".charAt(Math.floor(62 * Math.random()))), t--; return e.join("") }(); var t = n.c.callback,
                            ...
                            n.a = setTimeout(function() { if (n.a = null, n.b = null, e) try { e() } catch (t) {}
                                n.h && n.execute() }, 6e4) }, 500)) }, ih.prototype.delete = function() { rh(this), this.g = !0, clearTimeout(this.a), this.a = null, ye(this.f, "click", this.i) }, oh.prototype.g = function() { return th || (th = new Qc), wt(th) }, oh.prototype.c = function() {}; var ah = null;

                    function sh() { this.b = h.grecaptcha ? 1 / 0 : 0, this.f = null, this.a = "__rcb" + Math.floor(1e6 * Math.random()).toString() } var uh = pn("https://www.google.com/recaptcha/api.js?onload=%{onload}&render=explicit&hl=%{hl}"),
                        ch = new bi(3e4, 6e4);
                    sh.prototype.g = function(r) { var o = this; return new dt(function(t, e) { var i = setTimeout(function() { e(new Vi("network-request-failed")) }, ch.get());!h.grecaptcha || r !== o.f && !o.b ? (h[o.a] = function() { if (h.grecaptcha) { o.f = r; var n = h.grecaptcha.render;
                                    h.grecaptcha.render = function(t, e) { return t = n(t, e), o.b++, t }, clearTimeout(i), t(h.grecaptcha) } else clearTimeout(i), e(new Vi("internal-error"));
                                delete h[o.a] }, wt(Zo(gn(uh, { onload: o.a, hl: r || "" }))).s(function() { clearTimeout(i), e(new Vi("internal-error", "Unable to load external reCAPTCHA dependencies!")) })) : (clearTimeout(i), t(h.grecaptcha)) }) }, sh.prototype.c = function() { this.b-- }; var hh = null;
                    ...
                    function lh(t, e, n, i, r, o, a) { if (Si(this, "type", "recaptcha"), this.c = this.f = null, this.D = !1, this.m = e, this.g = null, a = a ? (ah || (ah = new oh), ah) : (hh || (hh = new sh), hh), this.o = a, this.a = n || { theme: "light", type: "image" }, this.h = [], this.a[ph]) throw new Vi("argument-error", "sitekey should not be provided for reCAPTCHA as one is automatically provisioned for the current project."); if (this.i = "invisible" === this.a[vh], !h.document) throw new Vi("operation-not-supported-in-this-environment", "RecaptchaVerifier is only supported in a browser HTTP/HTTPS environment with DOM support."); if (!Pn(e) || !this.i && Pn(e).hasChildNodes()) throw new Vi("argument-error", "reCAPTCHA container is either not found or already contains inner elements!");
                        this.u = new oa(t, o || null, r || null), this.v = i || function() { return null }; var s = this;
                        this.l = []; var u = this.a[fh];
                        this.a[fh] = function(t) { if (mh(s, t), "function" == typeof u) u(t);
                            else if ("string" == typeof u) { var e = ai(u, h); "function" == typeof e && e(t) } }; var c = this.a[dh];
                        this.a[dh] = function() { if (mh(s, null), "function" == typeof c) c();
                            else if ("string" == typeof c) { var t = ai(c, h); "function" == typeof t && t() } } } var fh = "callback",
                        dh = "expired-callback",
                        ph = "sitekey",
                        vh = "size";
                    ...
                    function yh(t, e, n) { var i = !1; try { this.b = n || Lh.app() } catch (t) { throw new Vi("argument-error", "No firebase.app.App instance is currently initialized.") } if (!this.b.options || !this.b.options.apiKey) throw new Vi("invalid-api-key");
                        n = this.b.options.apiKey; var r = this,
                            o = null; try { o = this.b.auth().ya() } catch (t) {} try { i = this.b.auth().settings.appVerificationDisabledForTesting } catch (t) {}
                    ...
                    function wh(t, e, n, i) { t: { n = Array.prototype.slice.call(n); for (var r = 0, o = !1, a = 0; a < e.length; a++)
                                if (e[a].optional) o = !0;
                                else { if (o) throw new Vi("internal-error", "Argument validator encountered a required argument after an optional argument.");
                                    r++ }
                            if (o = e.length, n.length < r || o < n.length) i = "Expected " + (r == o ? 1 == r ? "1 argument" : r + " arguments" : r + "-" + o + " arguments") + " but got " + n.length + ".";
                                    ...
                                    if (o = e[r].optional && void 0 === n[r], !e[r].M(n[r]) && !o) { if (e = e[r], r < 0 || r >= Ih.length) throw new Vi("internal-error", "Argument validator received an unsupported number of arguments.");
                                        n = Ih[r], i = (i ? "" : n + " argument ") + (e.name ? '"' + e.name + '" ' : "") + "must be " + e.K + "."; break t }
                                i = null } } if (i) throw new Vi("argument-error", t + " failed: " + i) }(t = lh.prototype).za = function() { var e = this; return this.f ? this.f : this.f = gh(this, wt().then(function() { if (ci() && !$n()) return Jn(); throw new Vi("operation-not-supported-in-this-environment", "RecaptchaVerifier is only supported in a browser HTTP/HTTPS environment.") }).then(function() { return e.o.g(e.v()) }).then(function(t) { return e.g = t, ns(e.u, qa, {}) }).then(function(t) { e.a[ph] = t.recaptchaSiteKey }).s(function(t) { throw e.f = null, t })) }, t.render = function() { bh(this); var n = this; return gh(this, this.za().then(function() { if (null === n.c) { var t = n.m; if (!n.i) { var e = Pn(t);
                                    t = Cn("DIV"), e.appendChild(t) }
                                n.c = n.g.render(t, n.a) } return n.c })) }, t.verify = function() { bh(this); var r = this; return gh(this, this.render().then(function(e) { return new dt(function(n) { var t = r.g.getResponse(e); if (t) n(t);
                                else { var i = function(t) { var e;
                    ...
                    function Ph(t, e) { for (var n in e) { var i = e[n].name;
                            t[i] = Ch(i, t[n], e[n].j) } }

                    function Rh(t, e) { for (var n in e) { var i = e[n].name;
                    ...
                    function Ch(t, e, n) {
                        function i() { var t = Array.prototype.slice.call(arguments); return wh(a, n, t), e.apply(this, t) } if (!n) return e; var r, o, a = (o = (o = t).split("."))[o.length - 1]; for (r in e) i[r] = e[r]; for (r in e.prototype) i.prototype[r] = e.prototype[r]; return i }
                    Ph(Kc.prototype, { Wa: { name: "applyActionCode", j: [Th("code")] }, Ja: { name: "checkActionCode", j: [Th("code")] }, Za: { name: "confirmPasswordReset", j: [Th("code"), Th("newPassword")] }, xb: { name: "createUserWithEmailAndPassword", j: [Th("email"), Th("password")] }, Wb: { name: "createUserAndRetrieveDataWithEmailAndPassword", j: [Th("email"), Th("password")] }, Zb: { name: "fetchProvidersForEmail", j: [Th("email")] }, $b: { name: "fetchSignInMethodsForEmail", j: [Th("email")] }, fa: { name: "getRedirectResult", j: [] }, oc: { name: "isSignInWithEmailLink", j: [Th("emailLink")] }, uc: { name: "onAuthStateChanged", j: [Oh(Ah(), kh(), "nextOrObserver"), kh("opt_error", !0), kh("opt_completed", !0)] }, vc: { name: "onIdTokenChanged", j: [Oh(Ah(), kh(), "nextOrObserver"), kh("opt_error", !0), kh("opt_completed", !0)] }, kb: { name: "sendPasswordResetEmail", j: [Th("email"), Oh(Ah("opt_actionCodeSettings", !0), Sh(null, !0), "opt_actionCodeSettings", !0)] }, lb: { name: "sendSignInLinkToEmail", j: [Th("email"), Ah("actionCodeSettings")] }, mb: { name: "setPersistence", j: [Th("persistence")] }, Pa: { name: "signInAndRetrieveDataWithCredential", j: [Nh()] }, Qa: { name: "signInAnonymously", j: [] }, Gc: { name: "signInAnonymouslyAndRetrieveData", j: [] }, Hc: { name: "signInWithCredential", j: [Nh()] }, Nb: { name: "signInWithCustomToken", j: [Th("token")] }, Ec: { name: "signInAndRetrieveDataWithCustomToken", j: [Th("token")] }, Ob: { name: "signInWithEmailAndPassword", j: [Th("email"), Th("password")] }, Ic: { name: "signInWithEmailLink", j: [Th("email"), Th("emailLink", !0)] }, Fc: { name: "signInAndRetrieveDataWithEmailAndPassword", j: [Th("email"), Th("password")] }, Jc: { name: "signInWithPhoneNumber", j: [Th("phoneNumber"), _h()] }, Kc: { name: "signInWithPopup", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, Lc: { name: "signInWithRedirect", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, Qc: { name: "updateCurrentUser", j: [Oh({ name: "user", K: "an instance of Firebase User", optional: !1, M: function(t) { return !!(t && t instanceof ec) } }, Sh(), "user")] }, nb: { name: "signOut", j: [] }, toJSON: { name: "toJSON", j: [Th(null, !0)] }, Sc: { name: "useDeviceLanguage", j: [] }, Tc: { name: "verifyPasswordResetCode", j: [Th("code")] } }), Rh(Kc.prototype, { lc: { name: "languageCode", tb: Oh(Th(), Sh(), "languageCode") } }), (Kc.Persistence = Ys).LOCAL = "local", Kc.Persistence.SESSION = "session", Kc.Persistence.NONE = "none", Ph(ec.prototype, { delete: { name: "delete", j: [] }, dc: { name: "getIdTokenResult", j: [Eh("opt_forceRefresh", !0)] }, F: { name: "getIdToken", j: [Eh("opt_forceRefresh", !0)] }, eb: { name: "linkAndRetrieveDataWithCredential", j: [Nh()] }, pc: { name: "linkWithCredential", j: [Nh()] }, qc: { name: "linkWithPhoneNumber", j: [Th("phoneNumber"), _h()] }, rc: { name: "linkWithPopup", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, sc: { name: "linkWithRedirect", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, gb: { name: "reauthenticateAndRetrieveDataWithCredential", j: [Nh()] }, yc: { name: "reauthenticateWithCredential", j: [Nh()] }, zc: { name: "reauthenticateWithPhoneNumber", j: [Th("phoneNumber"), _h()] }, Ac: { name: "reauthenticateWithPopup", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, Bc: { name: "reauthenticateWithRedirect", j: [{ name: "authProvider", K: "a valid Auth provider", optional: !1, M: function(t) { return !!(t && t.providerId && t.hasOwnProperty && t.hasOwnProperty("isOAuthProvider")) } }] }, reload: { name: "reload", j: [] }, jb: { name: "sendEmailVerification", j: [Oh(Ah("opt_actionCodeSettings", !0), Sh(null, !0), "opt_actionCodeSettings", !0)] }, toJSON: { name: "toJSON", j: [Th(null, !0)] }, Pc: { name: "unlink", j: [Th("provider")] }, pb: { name: "updateEmail", j: [Th("email")] }, qb: { name: "updatePassword", j: [Th("password")] }, Rc: { name: "updatePhoneNumber", j: [Nh("phone")] }, rb: { name: "updateProfile", j: [Ah("profile")] } }), Ph(Qc.prototype, { execute: { name: "execute" }, render: { name: "render" }, reset: { name: "reset" }, getResponse: { name: "getResponse" } }), Ph(Zc.prototype, { execute: { name: "execute" }, render: { name: "render" }, reset: { name: "reset" }, getResponse: { name: "getResponse" } }), Ph(dt.prototype, { ia: { name: "finally" }, s: { name: "catch" }, then: { name: "then" } }), Rh(qu.prototype, { appVerificationDisabled: { name: "appVerificationDisabledForTesting", tb: Eh("appVerificationDisabledForTesting") } }), Ph(Hu.prototype, { confirm: { name: "confirm", j: [Th("verificationCode")] } }), Dh(Fr, "credential", function(t, e) { return new Kr(t, e) }, [Th("email"), Th("password")]), Ph(Dr.prototype, { ua: { name: "addScope", j: [Th("scope")] }, Da: { name: "setCustomParameters", j: [Ah("customOAuthParameters")] } }), Dh(Dr, "credential", Cr, [Oh(Th(), Ah(), "token")]), Dh(Fr, "credentialWithLink", qr, [Th("email"), Th("emailLink")]), Ph(Lr.prototype, { ua: { name: "addScope", j: [Th("scope")] }, Da: { name: "setCustomParameters", j: [Ah("customOAuthParameters")] } }), Dh(Lr, "credential", xr, [Oh(Th(), Ah(), "token")]), Ph(Mr.prototype, { ua: { name: "addScope", j: [Th("scope")] }, Da: { name: "setCustomParameters", j: [Ah("customOAuthParameters")] } }), Dh(Mr, "credential", jr, [Oh(Th(), Oh(Ah(), Sh()), "idToken"), Oh(Th(), Sh(), "accessToken", !0)]), Ph(Ur.prototype, { Da: { name: "setCustomParameters", j: [Ah("customOAuthParameters")] } }), Dh(Ur, "credential", Vr, [Oh(Th(), Ah(), "token"), Th("secret", !0)]), Ph(Rr.prototype, { ua: { name: "addScope", j: [Th("scope")] }, credential: { name: "credential", j: [Oh(Th(), Sh(), "idToken", !0), Oh(Th(), Sh(), "accessToken", !0), Oh(Th(), Sh(), "nonce", !0)] }, Da: { name: "setCustomParameters", j: [Ah("customOAuthParameters")] } }), Dh(Gr, "credential", Xr, [Th("verificationId"), Th("verificationCode")]), Ph(Gr.prototype, { Ua: { name: "verifyPhoneNumber", j: [Th("phoneNumber"), _h()] } }), Ph(Vi.prototype, { toJSON: { name: "toJSON", j: [Th(null, !0)] } }), Ph(no.prototype, { toJSON: { name: "toJSON", j: [Th(null, !0)] } }), Ph(eo.prototype, { toJSON: { name: "toJSON", j: [Th(null, !0)] } }), Ph(yh.prototype, { clear: { name: "clear", j: [] }, render: { name: "render", j: [] }, verify: { name: "verify", j: [] } }),
                        function() { if (void 0 === Lh || !Lh.INTERNAL || !Lh.INTERNAL.registerService) throw Error("Cannot find the firebase namespace; be sure to include firebase-app.js before this library."); var t = { Auth: Kc, Error: Vi };
